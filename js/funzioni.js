...
function control_numero(campo)
{
	...
	//Controllo se � un numero regolare
	if(isFinite(valore))
	{
		//Se � un numero correggo se � negativo
		if (valore.charAt(0) == "-")	
			{	valore *= -1; 	}
	...
	if(array_valore.length==2)
	{
		...
		{
			//Correggo primo elemento se � negativo
			...
			{
				//Correggo secondo elemento se � negativo
	...
	(
		{
			...
			success: function (checkkRif)
			{
				...
				{
					alert ("Il riferimento inserito � gi� in un altro verbale");
				...
				success: function (selectTrasgr)
				{
					if (selectTrasgr != "")
					{
						...
						while (scorro < lunghArray)
						{
							...
							frase = "1In memoria esiste gi� un utente con dati:\n\n";
			...
			function (selectTrasgr)
			{
				...
				if (selectTrasgr != "")
				{
					...
					while (scorro < lunghArray)
					{
						...
						frase = "In memoria esiste gi� un utente con dati:\n\n";
						frase += "Cognome: " + Cognome + "\n";
						frase += "Nome: " + Nome + "\n";
						frase += "Genere: " + Genere + "\n";
						frase += "Data_Nascita: " + Data_Nascita + "\n";
					...
					success: function (selectTrasgr)
					{
						...
						if (selectTrasgr != "")
						{
							...
							while (scorro < lunghArray)
							{
								...
								frase = "2In memoria esiste gi� un utente collegato alla targa " + targa + ":\n\n";
								frase += "Cognome: " + Cognome + "\n";
								frase += "Nome: " + Nome + "\n";
								frase += "Genere: " + Genere + "\n";
								frase += "Data_Nascita: " + Data_Nascita + "\n";
