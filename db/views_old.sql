...
utente.Nome, if(utente.Genere="D",utente.Partita_Iva,utente.Codice_Fiscale) AS CF_PI,
utente.Data_Nascita, utente.Comune_Nascita, utente.Paese_Nascita, utente.Data_Morte,
