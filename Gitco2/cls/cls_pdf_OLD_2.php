...
//        $this->Cell (116, 5, $a_header['placeDate'] ,0, 1, "L");
    ...
    public function setRowPageTotal($a_value, $fontSize=8, $fontHeader=10, $limit=40, $a_total = array(),$force ){
        if(is_array($this->a_totalsHeader)){
            $this->getTotals($a_value);
        }
        $this->SetFont('Arial', '', $fontSize);
    ...
    public function setMainPage($a_filters, $recap, $orientation=null){
