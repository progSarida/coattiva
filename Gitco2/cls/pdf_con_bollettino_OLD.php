...
include_once $_SERVER['DOCUMENT_ROOT']."/coattiva/cls/tcpdf/tcpdf.php";
...
class pdf_con_bollettino extends TCPDF
{
	...
	public function limita_dim_immagine ($img, $maxLarghezza, $maxAltezza)  //  img deve arrivare in formato "/gitco2/stemmi/cogorno.png"
	{
	...
	{
		$dim_img = $this->limita_dim_immagine($logo, 20, 11);
	...
	public function intestazione_pdf($tipo_gestore , $image_file, $intest_gestore, $intest_ufficio )
	{
		...
		$dim = $this->limita_dim_immagine($image_file, 18, 22);
...
// 		$this->Image($image_file, $offsetx, 6+$offsety, $dim[0], $dim[1],'','','C' );//Logo
	...
	public function destinatario_intestazione_pdf($utente_id,$c,$nome_utente,$ID_partita,$anno_rif,$indirizzo_destinatario, $luogo_data, $tipo_codice = null, $protocollo=null, $data_protocollo = null )
	{
		...
		else if(isset($indirizzo_destinatario['a_destinatario'])){
            for($x_utente = 0;$x_utente<count($indirizzo_destinatario['a_destinatario']);$x_utente++)
            {
                $array_utente[$x_utente] = $indirizzo_destinatario['a_destinatario'][$x_utente];
            }
        }
        ...
        if($ID_partita!="")
        {
            ...
            $this->Cell (81 , 5, $ID_partita." / ".$anno_rif, 0, 0, "L");
        }
        else{
        ...
        $this->Cell ( 60 , 5, $utente_id." / ".$c, 0, 0, "L");
	...
	public function firma_pdf($firma, $ctrl_testo = null)
	{
		...
		{
			$dim_1 = $this->limita_dim_immagine($firma[1]['firma'], 60, 18);
			$offset = (60-$dim_1[0])/2;
		...
		{
			$dim_2 = $this->limita_dim_immagine($firma[2]['firma'], 60, 18);
	...
	public function firma_destra($firma, $ctrl_testo = null)
	{
		...
		{
			$dim_1 = $this->limita_dim_immagine($firma['firma'], 60, 18);
			$offset = (60-$dim_1[0])/2;
