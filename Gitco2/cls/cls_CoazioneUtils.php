...
// 				break;
  ...
  {
    $path = ARCHIVIO."/Posta_Elettronica/".$c."/".$tipo_mail."/";
    $path.= $oggetto;

	$pathWeb = ARCHIVIO_WEB."/Posta_Elettronica/".$c."/".$tipo_mail."/";
    $pathWeb.= $oggetto;
  ...
  public function gestione_totali($data,$type="array")
	{
		if($type == "object") {
			...
			$data->Totali_Num[1] = $totale_1;
			$data->Totali_Num[2] = $totale_2;
			$data->Totali_Num[3] = $totale_3;
			...
			$dataArray["Totali_Num"][1] = $totale_1;
			$dataArray["Totali_Num"][2] = $totale_2;
			$dataArray["Totali_Num"][3] = $totale_3;
