        ...
        if($print_type != "temp") {
            ...
            if( !is_dir($path)) mkdir($path);
            {
                if ($this->tipo == "Previdenziali")
                    $nameFile = "Stragiudiziale_Previdenziali_" .$this->denom_cc ."[".$this->CC . "]_" . $this->istituto['Previdenza_Id'] . ".pdf";
                else
                    $nameFile = "Stragiudiziale_Banca_" .$this->denom_cc."[". $this->CC . "]_" . $this->istituto['Banca_Id'] . ".pdf";
            }
        }
        else{
            ...
            {
                if ($this->tipo == "Previdenziali")
                    $nameFile = "Stragiudiziale_Previdenziali_" .$this->denom_cc ."[". $this->CC . "]_" . $this->istituto['Previdenza_Id'] . "_" . date('Y-m-d') . "_".$contatoreRecord.".pdf";
                else
                    $nameFile = "Stragiudiziale_Banca_" .$this->denom_cc ."[". $this->CC . "]_" . $this->istituto['Banca_Id'] . "_" . date('Y-m-d') . "_".$contatoreRecord.".pdf";
            }
        }
