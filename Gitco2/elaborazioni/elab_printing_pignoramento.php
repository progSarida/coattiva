...
// $prendi_path_temp_web=fn($Suffix="Copia")=>"/var/www/PIPPO_".$Suffix.".pdf";
...
if (count($a_results) == 0)
    ...
    if($filter['printType'] == "temp"){
        ...
        $a_dbParams_elab_list = array(
            ...
            'fields' => array(
                array('name' => 'Elaboration_Status_Id',  'type' => 'int', 'value' => 12),
        ...
        {
            $a_dbParams_elab['fields'][] = array('name' => 'Elaboration_Status_Id',        'type' => 'int', 'value' => 12);
