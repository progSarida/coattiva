...
<script>
    ...
    F11_button = function(){
        ...
        $("#frameHelp").attr("src","<?= SUPER_WEB_ROOT."/archivio/help/Stampa_Sgravi_Annull.pdf"; ?>");
        $("#helpModalLabel").empty().append("<b>Help Stampa Discarichi/Annullamenti</b>");
...
<form id="sgravio_annull_form" name="sgravio_annull_form" action="stampa_sgravio_annull.php" method="post" >
    ...
    <div class="row justify-content-md-center " style="margin: 2%;">
        <div class="col col-md-auto text_center">
            <span class="titolo font16 under_decor">Stampa discarichi annullamenti (Art. 19 D.Lgs. 112/99)</span>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col col-lg-3 col-lg-offset-1" >
            ...
            <div class="form-group">
                <div class="col-lg-6">
                    <select id="sgravio_annull" name="sgravio_annull" class="form-control resize" tabindex=1>
                        <option value=""></option>
                        <option value="annull" <?php echo $selectAnnull; ?> >ANNULLAMENTO</option>
                    </select>
                </div>
            </div>
        </div>
        <div class="col col-lg-4">
            <label class="col-lg-6 control-label resize" style="text-align: left;">Anno elaborazione da</label>
            <div class="form-group">
                <div class="col-lg-6">
        ...
        <!--<div class="col col-lg-4 ">
            <label class="col-lg-6 control-label resize" style="text-align: left;">Data discarico da</label>
            <div class="form-group">
                <div class="col-lg-6">
