...
$query.= "PAR_PAG.Numero_Conto, PAR_PAG.CC, PARTITA.Tipo AS Tipo_Riscossione, PARTITA.Sottotipo AS Sottotipo_Riscossione ";
$query.= "FROM pagamento PAG JOIN partita_tributi PARTITA ON PAG.Partita_ID = PARTITA.ID AND PAG.Conto_Terzi!='Y' ";
$query.= "JOIN parametri_pagamento PAR_PAG ON PAG.CC = PAR_PAG.CC AND PAR_PAG.Tipo_Riscossione!='CDSESTERO' ";
$query.= "LEFT JOIN comuni_lista CL ON CL.Com_Codice_Catastale = PAR_PAG.CC ";
...
$query.= "AND PAG.Data_Pagamento >='".$dadata."' AND  PAG.Data_Pagamento<='".$adata."' AND PAR_PAG.Tipo_Riscossione = PARTITA.Tipo ";

if ($comuni=="NO") 	$query .= "AND PAR_PAG.CC  = '".$c."' ";
else				$query .= "AND PAR_PAG.CC  != 'ZZZZ' ";

$query .= "GROUP BY PAG.Data_Pagamento, PAG.Modalita, PAR_PAG.Tipo_Riscossione, PAR_PAG.Numero_Conto, PAR_PAG.CC, CL.Com_Nome ";
$query .= "ORDER BY PAR_PAG.CC, PAR_PAG.Tipo_Riscossione, PAG.Modalita, PAG.Data_Pagamento ";
