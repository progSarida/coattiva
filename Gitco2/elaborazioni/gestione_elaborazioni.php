...
if($Select_Tax<1 && $printType!="elab")
...
$cls_print = new cls_print($printType,$docType,$a_city);
...
<!-- -->
    ...
    <script>
        ...
        switchMenuImg("F5");
        F5_button = function(){
            location.href="gestione_elaborazioni.php?printType=<?php echo $printType; ?>&docType=<?php echo $docType; ?>&c=<?php echo $c; ?>&a=<?php echo $a; ?>";
            //location.href="gestione_stampe.php?printType=<?php echo $printType; ?>&docType=<?php echo $docType; ?>&c=<?php echo $c; ?>&a=<?php echo $a; ?>";
        }

        <?php
        if(empty($cls_print->a_type['action']))
            $action = "";
        else
            $action = $cls_print->a_type['action'];
        ?>
        ...
        function changeAction(field){
            ...
            var form = document.getElementById('elab_form');
            form.action = action;
            form.target = "elabora";
            $('#elab_form').attr('onsubmit', "window.open('', 'elabora', 'width=1050,height=500,top=70,left=70,scrollbars=yes,menubar=no')");
    ...
    <form id="elab_form" name="elab_form" action="<?php echo $cls_print->a_type['action']; ?>" method="post" target="stampa" onSubmit="window.open('', 'stampa', 'width=1050,height=500,top=70,left=70,scrollbars=yes,menubar=no')">
...
<br><br>
        <?php echo $cls_print->getMessages(); ?>
