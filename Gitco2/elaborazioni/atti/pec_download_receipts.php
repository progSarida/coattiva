...
if($error == 0){
    ...
    $storico->insRow('E', "Scaricate ricevute PEC elemento ".$cls_help->getVar('Elaboration_List_Id')." elaborazione '".$elab['Description']."' (".$tipo_doc['Description'].") ente ".$nome_ente."[".$elab['CC']."]");
}
