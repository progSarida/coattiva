...
if(!is_file($zip)){
    ...
    header("Location: ".ELAB_ATTI_WEB."/mgmt_elaboration.php?c=".$c."&a=".$a."&el=".$Elaboration_Id."&error=1&msg=".$msg);
...
header("Location: ".ELAB_ATTI_WEB."/mgmt_elaboration.php?c=".$c."&a=".$a."&el=".$Elaboration_Id."&error=1&msg=".$msg.$filesMsg);
