...
if (count($atti) > 0) {
    ...
    foreach ($atti as $key => $atto) {
        ...
        if (!is_null($atto['Atto_Last_ID'])) {
            ...
            $interessi_prec = $atto['Interessi_Precedenti_ATTO'] + $atto['Interessi_ATTO'];
            ...
            $totale_pagamenti = $atto['TOTALE_PAGAMENTI'];
        ...
        $sum_imp_tributo += $spese_not_precedenti;
   ...
   */
        ...
        $totale_dovuto =  $imp_codici_tot + $spe_not + $spese_not_precedenti + $interessi_new + $interessi_prec;
