...
if (strtolower($_SESSION['username']) == "mirkop" || strtolower($_SESSION['username']) == "michele" || strtolower($_SESSION['username']) == "fabrizio" || strtolower($_SESSION['username']) == "emanuela" || strtolower($_SESSION['username']) == "robertop")
    $authFlag = 1;
else
    $authFlag = 0;
...
$actionSignedFiles = ELAB_ATTI_WEB."/upload_signed_files.php";
...
switch($a_elab['Elaboration_Status_Id']){
    ...
    <script src="<?= ELAB_ATTI_JS ?>/elabStatus1.js"></script>
...
<?php
        ...
        case 2:
            //setto il default
            AggiornaDefault::AggiornaIngiunzioni($cls_db,$elab_id);
    ...
    <script src="<?= ELAB_ATTI_JS ?>/elabStatus2.js"></script>
                    ...
                    if($a_elab_list['Elaboration_Status_Id']<7){
                        if($a_elab_list['PrintTypeId']==4){//SPEDIZIONE PEC
                            ...
                            if($a_elab_list['PecReceiptsFlag']==1){
                                ...
                                WHERE A.Elaboration_List_Id=".$a_elab_list['ID']." AND E.Delivery_Receipt is null AND (A.Motivo_Notifica=0 OR A.Motivo_Notifica is null)";
    ...
    <script src="<?= ELAB_ATTI_JS ?>/elabStatus4.js"></script>
