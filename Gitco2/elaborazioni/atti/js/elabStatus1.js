    ...
    $('#dt_table').DataTable( {
        ...
        ajax: {
            url: web_dteditor+"/ss_elab_status_1.php",
            type: "POST",
            data: {
        ...
        columns: [
            { data: "v_pre_elab_acts.Comune_ID" },
            { data: "v_pre_elab_acts.Tipo_Riscossione" },
            { data: "v_pre_elab_acts.Info_Cartella" },
            { data: "v_pre_elab_acts.Anomalia_ATTO" },
            { data: "v_pre_elab_acts.Position_Status" },
            { data: "v_pre_elab_acts.flag_elaboration" }
        ],
        columnDefs: [
            {
            ...
            },
            {
                ...
                render: function ( data, type, row, meta ) {
                        return '<a href="'+web_root+'/coattiva/ingiunzione.php?partita='+row.v_pre_elab_acts.Partita_ID+'&c='+row.v_pre_elab_acts.CC+'"><b>'+data+'</b></a>';
                    }
            },
            {
                searchPanes: { show: false }, targets: 5, className: 'dt-center',
                render: function ( data, type, row, meta ) {
                        switch(parseInt(row.v_pre_elab_acts.Position_Status_Id)){
                            case 1: case 2: case 3:
                            case 5: case 8: case 17:
                            case 19: case 20: case 21: case 22: case 35:
                                disabled = "";
                                break;
                            default:
                                disabled = "disabled";
                        ...
                        if(data==1)
                            ...
                            checked = "";
                        return ' <input type="checkbox" '+disabled+' '+checked+' value="1" id="flag_check_'+row.v_pre_elab_acts.Partita_ID+'" name="flag_check_'+row.v_pre_elab_acts.Partita_ID+'">';
                    }
            }
        ],
