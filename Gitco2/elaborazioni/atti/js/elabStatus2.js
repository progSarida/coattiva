    ...
    $('#dt_table').DataTable( {
        ...
        ajax: {
            url: web_dteditor+"/ss_elab_status_2.php",
            type: "POST",
            data: {
        ...
        columnDefs: [
            ...
            },
            {
                ...
                render: function ( data, type, row, meta ) {
                        let select = '<select class="AjaxUpdate" data-cc="'+row.v_elab_acts.CC+'" data-field="PrinterId" data-partita="'+row.v_elab_acts.Partita_ID+'">';
            ...
            },
            {
                ...
                render: function ( data, type, row, meta ) {
                        let select = '<select class="AjaxUpdate" data-cc="'+row.v_elab_acts.CC+'" data-field="PrintTypeId" data-partita="'+row.v_elab_acts.Partita_ID+'">';
            ...
            },
            {
                ...
                render: function ( data, type, row, meta ) {
                        let select = '<select class="AjaxUpdate" data-cc="'+row.v_elab_acts.CC+'" data-field="Tipo_Ufficiale" data-partita="'+row.v_elab_acts.Partita_ID+'">';
    ...
    $(document).ready(function() {
        $('#dt_table').on('change', '.AjaxUpdate', function() {
            updateAttoField($(this).data('partita'), $(this).data('field'), $(this).val(), $(this).data('cc'));
        });
    });
    ...
    function updateAttoField(partita, field, value, cc) {
        $.ajax({
