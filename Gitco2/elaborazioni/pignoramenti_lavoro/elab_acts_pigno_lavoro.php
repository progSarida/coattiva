...
if (count($pignoramenti) > 0) {
    ...
    try {
        ...
        $a_dbParams = array(
            ...
            'fields'=> array(
                array(  'name' => 'Elaboration_Status_Id',  'type' => 'int', 'value' => ElaborationStatus::ASSEGNA_DATORE_LAVORO),
    ...
    $storico->insRow('E', "Elaborato '".$a_elaboration['Description']."': Pignoramenti presso datore di lavoro ".$ente['Denominazione']."[".$a_elaboration['CC']."]. Stato 'Assegna datore di lavoro'");
