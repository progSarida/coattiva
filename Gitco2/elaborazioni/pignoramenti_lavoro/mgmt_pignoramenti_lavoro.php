...
if (strtolower($_SESSION['username']) == "michele" || strtolower($_SESSION['username']) == "mirkop" 
...
switch($a_elab['Elaboration_Status_Id']){
    ...
    <script>
        ...
        F3_button = function() {
            if (submit_buttons('Elabora')) {
                location.href ='elab_acts_pigno_lavoro.php?c=<?=$c;?>&a=<?=$a;?>&el=<?=$a_elab['Id'];?>';
            }
        }
        switchMenuImg("F11");
        F11_button = function(){
    ...
    <script src="<?= ELAB_PIGNORAMENTI_LAVORO_JS ?>/elabPignoStatusLavoro1.js"></script>

<?php
        break;
        case ElaborationStatus::ASSEGNA_DATORE_LAVORO:

?>
<script src="<?= ELAB_PIGNORAMENTI_LAVORO_JS ?>/controlla_assenti.js"></script>
<script>
    switchMenuImg("F3");
    function GoToCreaPignoramenti()
    {
        location.href = 'elab_pignoramenti_lavoro.php?c=<?=$c;?>&a=<?=$a;?>&el=<?=$a_elab['Id'];?>';
    }
    F3_button = function() {
...
<div style="padding: 0 30px 20px 30px;">
    ...
    <script src="<?= ELAB_PIGNORAMENTI_LAVORO_JS ?>/elabPignoAssegnaLavoro.js"></script>
    <script src="<?= ELAB_PIGNORAMENTI_LAVORO_JS ?>/AssegnaDatoreLavoro.js"></script>
<?php
            break;
        ...
        <script>
            ...
            F3_button = function() {
                if(callPec==0){
                    if (submit_buttons('Elabora')) {
                        location.href ='..\\pignoramenti\\elab_crono_assignment_notifica_atto.php?c=<?=$c;?>&a=<?=$a;?>&el=<?=$a_elab['Id'];?>&cod_cat=<?=$a_elab['CC'];?>&tipo_atto=<?=$a_elab['Document_Type_Id'];?>&terzo=lavoro';
                    }
                }
                else
        ...
        <script src="<?= ELAB_PIGNORAMENTI_LAVORO_JS ?>/elabPignoStatusLavoro10.js"></script>
        <?php
                break;
                                    ...
                                    if($a_elab_list['PecReceiptsFlag']==1){
                                        ...
                                        if($a_count['MissingReceiptNumber']==0){
                                            ...
                                            <script>
                                                ...
                                                location.href ="<?= ELAB_PIGNORAMENTI_LAVORO_WEB ?>/mgmt_pignoramenti_lavoro.php?c=<?=$c;?>&a=<?=$a;?>&el=<?=$a_elab['Id'];?>";
                                            </script>
                                            <?php
                                        }
                                        else{
            ...
            <script src="<?= ELAB_PIGNORAMENTI_LAVORO_JS ?>/elabPignoStatusLavoro11.js"></script>
