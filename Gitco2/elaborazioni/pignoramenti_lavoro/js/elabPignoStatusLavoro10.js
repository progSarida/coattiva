    ...
    $('#dt_table').DataTable( {
        ...
        ajax: {
            url: web_dteditor+"/ss_elab_pigno_status_lavoro_10.php",
            type: "POST",
            data: {
        ...
        columns: [
            { data: "v_elab_acts_pignoramenti_lavoro.Comune_ID" },
            { data: "v_elab_acts_pignoramenti_lavoro.Tipo_Riscossione" },
            { data: "v_elab_acts_pignoramenti_lavoro.Info_Cartella" },
            { data: "v_elab_acts_pignoramenti_lavoro.Tipo_Notifica" },
            { data: "v_elab_acts_pignoramenti_lavoro.Printer" },
            { data: "v_elab_acts_pignoramenti_lavoro.PrintType" },
            { data: "v_elab_acts_pignoramenti_lavoro.Tipo_Ufficiale" },
            { data: "v_elab_acts_pignoramenti_lavoro.PEC" }
        ],
        buttons: [
            {
        ...
        columnDefs: [
            ...
            },
            {
                ...
                render: function ( data, type, row, meta ) {
                        return '<a href="'+web_root+'/coattiva/coazione.php?partita='+row.v_elab_acts_pignoramenti_lavoro.Partita_ID+'&c='+row.v_elab_acts_pignoramenti_lavoro.CC+'"><b>'+row.v_elab_acts_pignoramenti_lavoro.Comune_ID+'</b></a>';
                    }
            },
            {
                searchPanes: { show: true }, targets: 4, className: 'dt-center',
                render: function ( data, type, row, meta ) {
                        let select = '<select class="AjaxUpdate" data-pignoramento_id="'+row.v_elab_acts_pignoramenti_lavoro.Pignoramento_ID+'" data-cc="'+row.v_elab_acts_pignoramenti_lavoro.CC+'"  data-field="Printer_Id" data-notifica="'+row.v_elab_acts_pignoramenti_lavoro.Notifica_ID+'">';
            ...
            },
            {
                ...
                render: function ( data, type, row, meta ) {
                        let select = '<select class="AjaxUpdate"  data-pignoramento_id="'+row.v_elab_acts_pignoramenti_lavoro.Pignoramento_ID+'" data-cc="'+row.v_elab_acts_pignoramenti_lavoro.CC+'" data-field="PrintTypeId" data-notifica="'+row.v_elab_acts_pignoramenti_lavoro.Notifica_ID+'">';
            ...
            },
            {
                ...
                render: function ( data, type, row, meta ) {
                        let select = '<select class="AjaxUpdate"  data-pignoramento_id="'+row.v_elab_acts_pignoramenti_lavoro.Pignoramento_ID+'" data-cc="'+row.v_elab_acts_pignoramenti_lavoro.CC+'" data-field="Tipo_Ufficiale" data-notifica="'+row.v_elab_acts_pignoramenti_lavoro.Notifica_ID+'">';
            ...
            },
            {
                ...
                render: function ( data, type, row, meta ) {
                        a_check = checkPec(row.v_elab_acts_pignoramenti_lavoro.CF_PI, row.v_elab_acts_pignoramenti_lavoro.REC_PRESSO, row.v_elab_acts_pignoramenti_lavoro.PEC, row.v_elab_acts_pignoramenti_lavoro.InipecLoaded);
