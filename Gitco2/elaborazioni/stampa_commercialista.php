...
if($cls_help->getVar('comuni') == 'SI')
	$per = " per tutti gli enti";
else if ($cls_help->getVar('comuni') == 'NO')
	$per = " per ente ".$nome_ente."[".$c."]";

$storico->insRow('X', "Creato file TRAFAT '".$cls_help->getVar('tipo_riscossione')."' dal ".$cls_help->getVar('dadata')." al ".$cls_help->getVar('adata').$per);
?>
