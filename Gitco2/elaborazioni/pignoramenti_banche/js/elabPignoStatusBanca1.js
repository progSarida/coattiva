...
$('#dt_table').DataTable( {
    ...
    ajax: {
        url: web_dteditor+"/ss_elab_status_1_lavoro.php",
        type: "POST",
        data: {
    ...
    columns: [
        { data: "v_pre_elab_acts_lavoro.Comune_ID" },
        { data: "v_pre_elab_acts_lavoro.Tipo_Riscossione" },
        { data: "v_pre_elab_acts_lavoro.Info_Cartella" },
        { data: "v_pre_elab_acts_lavoro.Anomalia_ATTO" },
        { data: "v_pre_elab_acts_lavoro.Position_Status" },
        { data: "v_pre_elab_acts_lavoro.flag_elaboration" }
    ],
    columnDefs: [
        {
        ...
        },
        {
            ...
            render: function ( data, type, row, meta ) {
                    return '<a href="'+web_root+'/coattiva/ingiunzione.php?partita='+row.v_pre_elab_acts_lavoro.Partita_ID+'&c='+row.v_pre_elab_acts_lavoro.CC+'"><b>'+data+'</b></a>';
                }
        },
        {
            searchPanes: { show: false }, targets: 5, className: 'dt-center',
            render: function ( data, type, row, meta ) {
                    switch(parseInt(row.v_pre_elab_acts_lavoro.Position_Status_Id)){
                    ...
                    if(data==1)
                        ...
                        checked = "";
                    return ' <input type="checkbox" '+disabled+' '+checked+' value="1" id="flag_check_'+row.v_pre_elab_acts_lavoro.Partita_ID+'" name="flag_check_'+row.v_pre_elab_acts_lavoro.Partita_ID+'">';
                }
        }
    ],
