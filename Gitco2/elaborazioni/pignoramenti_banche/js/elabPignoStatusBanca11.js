        ...
        columnDefs: [
            ...
            },
            {
                ...
                render: function ( data, type, row, meta ) {
                        ...
                        if(row.v_manage_acts_pignoramenti.Tipo_Notifica=="banca")
                            tipo = "_banca";
                        else
    ...
    function printButton(el_list_Id) {
        ...
        $.ajax({
            ...
            success: function(response) {
                var response = JSON.parse(response);
                if (response.esito == "OK") {
                    location.href = web_root+"/elaborazioni/pignoramenti_banche/elab_printing_pignoramento_banche.php?c="+c+"&a="+a+"&el_list_id="+el_list_Id;
                } else {
                    console.log(response);
                    swal({
                        title: "ERROR!",
    ...
    function flowCreation(el_list_Id) {
        if (authFlag == 0) {
            ...
            location.href = web_root+"/elaborazioni/pignoramenti/elab_pigno_flows.php?c="+c+"&a="+a+"&el_list_id="+el_list_Id+"&terzo=banca";
        }
    }
    ...
    function sendPec(el_list_Id) {
        if (authFlag == 0) {
            ...
            location.href = web_root+"/elaborazioni/pignoramenti_banche/pec_send_pigno.php?c="+c+"&a="+a+"&Elaboration_Id="+elab_id+"&Elaboration_List_Id="+el_list_Id+"&terzo=banca";
        }
    }
    ...
    function checkPec(el_list_Id) {
        if (authFlag == 0) {
            ...
            location.href = web_root+"/elaborazioni/pignoramenti/pec_download_receipts_pigno.php?c="+c+"&a="+a+"&Elaboration_Id="+elab_id+"&Elaboration_List_Id="+el_list_Id+"&terzo=banca";
        }
    }
