    ...
    <div style="border-top: 2px solid #B0BBE8; width: 90%; margin-left: 5%;margin-bottom: 1%; margin-top: 1%;"></div>
        <div class="col col-lg-4 col-lg-offset-1">
            ...
            <div class="form-group">
                <div class="col-lg-8">
                <select class="form-select validateCustom vld_Custom_r"  id="DefaultTipoUfficialePEC" name="DefaultTipoUfficialePEC" style="height:35px; width:75%;">
                    <?= $optTipoUfficialePEC; ?>
                </select>
                </div>
            </div>
        ...
        <div class="col col-lg-4 col-lg-offset-1">
            ...
            <div class="form-group">
                <div class="col-lg-8">
                    <select id="DefaultTipoUfficialeRaccomandata" name="DefaultTipoUfficialeRaccomandata"  style="height:35px; width:75%;">
