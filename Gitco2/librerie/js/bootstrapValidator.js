...
(function($) {
    ...
    BootstrapValidator.prototype = {
        ...
        showError: function($field, validatorName) {
            ...
            //alert(validatorName); //riconosce su quale input si sta scrivendo
            ...
            $('#'+$field.attr('name')+'_span').html('<span class="glyphicon glyphicon-remove"></span>');

            //$('#Password').removeClass('glyphicon-asterisk').html('<span class="glyphicon glyphicon-remove"></span>');


            // Add has-error class to parent element
            $parent.removeClass('has-success').addClass('has-error');

            //alert($field.data('bootstrapValidator.error')
        ...
        removeError: function($field) {
            ...
            //$('#username').removeClass('glyphicon-asterisk').html('<i class="glyphicon glyphicon-ok"></i>');

  

                $('#'+$field.attr('name')+'_span').html('<span class="glyphicon glyphicon-ok">');





            //$('#Password').html('<i class="glyphicon glyphicon-ok"></i>');
