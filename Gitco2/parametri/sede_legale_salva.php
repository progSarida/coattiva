...
$id_collegamento = get_var('id_collegamento');
...
if($invia == "Salva")
{
	...
	$field_ente[] = "CC";				$value_ente[] = $CC_sede;
	...
	if($tipo_sede=="banca")
	{
		$field_ente[] = "Tipo_Banca";			$value_ente[] = $tipo_banca;
	}
	
	if($id_collegamento!=null)
	{
		$field_ente[] = "ID_Collegamento";		$value_ente[] = $id_collegamento;
	}
