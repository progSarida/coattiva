...
$a_param_PEC = $cls_db->getArrayLineNull($cls_db->ExecuteQuery($cls_param->Get_Query_EMail($c , "PEC", "GENERALE")),"parametri_email");
$a_param_email = $cls_db->getArrayLineNull($cls_db->ExecuteQuery($cls_param->Get_Query_EMail($c , "email", "GENERALE")),"parametri_email");
...
F11_button = function(){
    ...
    $("#frameHelp").attr("src","<?= SUPER_WEB_ROOT."/archivio/help/PEC_Mail.pdf"; ?>");
    $("#helpModalLabel").empty().append("<b>Help Parametri PEC/Mail</b>");
