...
$Richiesta_Pignoramento = get_var('richiesta_pignoramento');
$Sottoposto_Pignoramento = get_var('sottoposto_pignoramento');
$Sottoposto_Pignoramento_Testo = get_var('sottoposto_pignoramento_testo');
...
if ($invia == "Salva")
{
	...
	$myParametroAtto->Richiesta_Pignoramento = $Richiesta_Pignoramento;
	$myParametroAtto->Sottoposto_Pignoramento = $Sottoposto_Pignoramento;
	$myParametroAtto->Sottoposto_Pignoramento_Testo = $Sottoposto_Pignoramento_Testo;
