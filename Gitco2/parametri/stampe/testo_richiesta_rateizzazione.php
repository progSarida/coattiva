...
function salva_form() 
{
	if (CheckCampiObbligatori () == true)
	{
		if (CheckTuttiCampi () == true)
		{
			...
			if(control_salva)
       			$("#form_testo_richiesta_rateizzazione").submit();
		}
    }
}
...
function annulla() 
{
	...
	stringa = "testo_richiesta_rateizzazione.php?"+stringaPHP;
...
function CheckCampiObbligatori ()
 {
	...
	if (ParolaPresenteInStringa ("Sottoscritto", "{NOMEUTENTE}") == false) return false;
	if (ParolaPresenteInStringa ("Sottoscritto", "{COMUNENASCITA}") == false) return false;
	if (ParolaPresenteInStringa ("Sottoscritto", "{DATANASCITA}") == false) return false;
	if (ParolaPresenteInStringa ("Sottoscritto", "{INDIRIZZOUTENTE}") == false) return false;

	if (ParolaPresenteInStringa ("Atto_Testo", "{ATTO}") == false) return false;
	if (ParolaPresenteInStringa ("Atto_Testo", "{INFOCARTELLA}") == false) return false;
	
	if (ParolaPresenteInStringa ("Chiedo_Testo", "{DOVUTO}") == false) return false;
	if (ParolaPresenteInStringa ("Chiedo_Testo", "{NUMERORATE}") == false) return false;
...
{
	if (CheckCaratteri ("Sottoscritto") == false) return false;
	if (CheckCaratteri ("Atto_Testo") == false) return false;
	if (CheckCaratteri ("Chiedo") == false) return false;
	if (CheckCaratteri ("Chiedo_Testo") == false) return false;
	if (CheckCaratteri ("Condizioni_Disagiate") == false) return false;
	if (CheckCaratteri ("Condizione_1") == false) return false;
	if (CheckCaratteri ("Condizione_2") == false) return false;
	if (CheckCaratteri ("Condizione_3") == false) return false;
	if (CheckCaratteri ("Condizione_4") == false) return false;
	if (CheckCaratteri ("Condizione_5") == false) return false;
...
<table class="table_interna text_center" border="0" cellspacing="10" cellpadding="0">
	<tr>
		<td><font class="titolo font16 under_decor">Testo richiesta rateizzazione</font></td>
	</tr>
</table>
...
<table class="table_interna text_center" border="0">
	...
	<tr>
		<td class="width20">
			<div id="Sottoscritto">Sottoscritto:</div>
		</td>
		<td class="width4">
			<font size=-2>GIUS</font>
		</td>
		<td>
			<textarea name="Sottoscritto" onblur="CheckCaratteri(this);" onchange="CheckCampiObbligatori();" style="width:95%" rows="3"><?=$sottoscritto?></textarea>
		</td>
		<td>
			<font size=-2>
			{NOMEUTENTE}&nbsp;<br>{COMUNENASCITA}&nbsp;<br>{DATANASCITA}&nbsp;<br>{INDIRIZZOUTENTE}
			</font>
		</td>
	</tr>
	<tr>
		<td>
			<div id="Atto_Testo">Testo atto:</div>
		</td>
		<td>
			<font size=-2>GIUS</font>
		</td>
		<td>
			<textarea name="Atto_Testo" onblur="CheckCaratteri(this);" onchange="CheckCampiObbligatori();" style="width:95%" rows="3"><?=$testoAtto?></textarea>
		</td>
		<td>
			<font size=-2>
	...
	<tr>
		<td>
			<div id="Chiedo">Chiedo:</div>
		</td>
		<td>
			<font size=-2>CEN</font>
		</td>
		<td>
			<textarea name="Chiedo" onblur="CheckCaratteri(this);" onchange="CheckCampiObbligatori();" style="width:95%" rows="2"><?=$chiedo?></textarea>
		</td>
		<td>
			<font size=-2>
	...
	<tr>
		<td>
			<div id="Chiedo_Testo">Chiedo testo:</div>
		</td>
		<td>
			<font size=-2>CENT</font>
		</td>
		<td>
			<textarea name="Chiedo_Testo" onblur="CheckCaratteri(this);" onchange="CheckCampiObbligatori();" style="width:95%" rows="6"><?=$chiedoTesto?></textarea>
		</td>
		<td>
			<font size=-2>
			{DOVUTO}&nbsp;<br>{NUMERORATE}
			</font>
		</td>
	</tr>
	<tr>
		<td>
			<div id="Condizioni_Disagiate">Condizioni disagiate:</div>
		</td>
		<td>
			<font size=-2>GIUS</font>
		</td>
		<td>
			<textarea name="Condizioni_Disagiate" onblur="CheckCaratteri(this);" onchange="CheckCampiObbligatori();" style="width:95%" rows="4"><?=$condizioni_disagiate?></textarea>
		</td>
		<td>
			<font size=-2>
			{SOGGETTO}
	...
	<tr>
		<td>
			<div id="Condizione_1">Condizione 1:</div>
		</td>
		<td>
			<font size=-2>GIUS</font>
		</td>
		<td>
			<textarea name="Condizione_1" onblur="CheckCaratteri(this);" onchange="CheckCampiObbligatori();" style="width:95%" rows="2"><?=$condizione_1?></textarea>
		</td>
		<td>
			<font size=-2>
			</font>
	...
	<tr>
		<td>
			<div id="Condizione_2">Condizione 2:</div>
		</td>
		<td>
			<font size=-2>GIUS</font>
		</td>
		<td>
			<textarea name="Condizione_2" onblur="CheckCaratteri(this);" onchange="CheckCampiObbligatori();" style="width:95%" rows="2"><?=$condizione_2?></textarea>
		</td>
		<td>
			<font size=-2>
			</font>
	...
	<tr>
		<td>
			<div id="Condizione_3">Condizione 3:</div>
		</td>
		<td>
			<font size=-2>GIUS</font>
		</td>
		<td>
			<textarea name="Condizione_3" onblur="CheckCaratteri(this);" onchange="CheckCampiObbligatori();" style="width:95%" rows="2"><?=$condizione_3?></textarea>
		</td>
		<td>
			<font size=-2>
			</font>
	...
	<tr>
		<td>
			<div id="Condizione_4">Condizione 4:</div>
		</td>
		<td>
			<font size=-2>GIUS</font>
		</td>
		<td>
			<textarea name="Condizione_4" onblur="CheckCaratteri(this);" onchange="CheckCampiObbligatori();" style="width:95%" rows="2"><?=$condizione_4?></textarea>
		</td>
		<td>
			<font size=-2>
			</font>
	...
	<tr>
		<td>
			<div id="Condizione_5">Condizione 5:</div>
		</td>
		<td>
			<font size=-2>GIUS</font>
		</td>
		<td>
			<textarea name="Condizione_5" onblur="CheckCaratteri(this);" onchange="CheckCampiObbligatori();" style="width:95%" rows="2"><?=$condizione_5?></textarea>
		</td>
		<td>
			<font size=-2>
			</font>
