...
$myParametroAtto = new testo_pignoramento_lavoro(NULL);
$myId = $myParametroAtto->CercaParametroData($c, date("Y-m-d"));

$myParametroAtto = new testo_pignoramento_lavoro($myId);
...
$Datore_Lavoro = $myParametroAtto->Datore_Lavoro;
$Art545 = $myParametroAtto->Art545;
...
$Richiesta_Pignoramento = $myParametroAtto->Richiesta_Pignoramento;
$Sottoposto_Pignoramento = $myParametroAtto->Sottoposto_Pignoramento;
$Sottoposto_Pignoramento_Testo = $myParametroAtto->Sottoposto_Pignoramento_Testo;
...
function salva_form() 
{
	if (CheckCampiObbligatori () == true)
	{
		if (CheckTuttiCampi () == true)
		{
			...
			if(control_salva)
       			$("#form_testo_pignoramento_lavoro").submit();
		}
    }
}
...
function annulla() 
{
	...
	stringa = "testo_pignoramento_lavoro.php?"+stringaPHP;
...
function CheckTuttiCampi ()
{
	...
	if (CheckCaratteri ("art545") == false) return false;
	...
	if (CheckCaratteri ("richiesta_pignoramento") == false) return false;
...
$(document).ready(function(){
	...
	$('#form_testo_pignoramento_lavoro').ajaxForm(
...
<table class="table_interna text_center" border="0" cellspacing="10" cellpadding="0">
	<tr>
		<td><font class="titolo font16 under_decor">Testo Pignoramento presso datore di lavoro</font></td>
	</tr>
</table>
...
<form name="testo_pignoramento_lavoro" id="form_testo_pignoramento_lavoro" action="testo_pignoramento_lavoro_salva.php" method="post">
...
<table class="table_interna text_center" border="0">
	...
	<tr>
		<td>
			<div id="datore_lavoro">Datore di lavoro:</div>
		</td>
		<td>
			<font size=-2>GIUS</font>
		</td>
		<td>
			<textarea name="datore_lavoro" onkeyup="CheckCaratteri(name);" onchange="CheckCampiObbligatori();" style="width:95%" rows="4"><?=$Datore_Lavoro?></textarea>
		</td>
		<td>
			<font size=-2>
	...
	<tr>
		<td>
			<div id="art545">Articolo 545:</div>
		</td>
		<td>
			<font size=-2>CENT</font>
		</td>
		<td>
			<textarea name="art545" onkeyup="CheckCaratteri(name);" onchange="CheckCampiObbligatori();" style="width:95%" rows="7"><?=$Art545?></textarea>
		</td>
		<td>
			<font size=-2>
			</font>
	...
	<tr>
		...
		<td>
			<textarea name="terzo" onkeyup="CheckCaratteri(name);" onchange="CheckCampiObbligatori();" style="width:95%" rows="2"><?=$Terzo?></textarea>
		</td>
		<td>
			<font size=-2>
			</font>
	...
	<tr>
		<td>
			<div id="richiesta_pignoramento">Richiesta pignoramento:</div>
		</td>
		<td>
			<font size=-2>GIUS</font>
		</td>
		<td>
			<textarea name="richiesta_pignoramento" onkeyup="CheckCaratteri(name);" onchange="CheckCampiObbligatori();" style="width:95%" rows="3"><?=$Richiesta_Pignoramento?></textarea>
		</td>
		<td>
			<font size=-2>
			</font>
	...
	<tr>
		<td>
			<div id="sottoposto_pignoramento_testo">Sottoposto pignoramento testo:</div>
		</td>
		<td>
			<font size=-2>GIUS</font>
		</td>
		<td>
			<textarea name="sottoposto_pignoramento_testo" onkeyup="CheckCaratteri(name);" onchange="CheckCampiObbligatori();" style="width:95%" rows="8"><?=$Sottoposto_Pignoramento_Testo?></textarea>
		</td>
		<td>
			<font size=-2>
