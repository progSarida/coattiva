...
$Motivazione = get_var('Motivazione');
$Richiesta_Utente = get_var('Richiesta_Utente');
$Richiesta_Siatel = get_var('Richiesta_Siatel');
...
if ($invia == "Salva")
{
	...
	$myParametroAtto = new testo_richiesta_indirizzo(null); 
	...
	$myParametroAtto->Motivazione = $Motivazione;
	$myParametroAtto->Richiesta_Utente = $Richiesta_Utente;
	$myParametroAtto->Richiesta_Siatel = $Richiesta_Siatel;
