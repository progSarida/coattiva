...
$Richiesta_Duplicato = get_var('Richiesta_Duplicato');
$Urgenza_Richiesta = get_var('Urgenza_Richiesta');
...
if ($invia == "Salva")
{
	...
	$myParametroAtto = new testo_richiesta_duplicato_AR(null); 
	...
	$myParametroAtto->Richiesta_Duplicato = $Richiesta_Duplicato;
	$myParametroAtto->Urgenza_Richiesta = $Urgenza_Richiesta;
