...
$myParametroAtto = new testo_pignoramento_presso_terzi($myId);
...
$Ufficiale_Datore_Lavoro = $myParametroAtto->Ufficiale_Datore_Lavoro;
$Ufficiale_Banca = $myParametroAtto->Ufficiale_Banca;
$Sottoposto_Pignoramento = $myParametroAtto->Sottoposto_Pignoramento;
$Sottoposto_Pignoramento_Datore_Lavoro = $myParametroAtto->Sottoposto_Pignoramento_Datore_Lavoro;
...
function salva_form() 
{
	if (CheckCampiObbligatori () == true)
	{
		if (CheckTuttiCampi () == true)
		{
			...
			if(control_salva)
       			$("#form_testo_pignoramento_presso_terzi").submit();
		}
    }
}
...
function annulla() 
{
	...
	stringa = "testo_pignoramento_presso_terzi.php?"+stringaPHP;
...
$(document).ready(function(){
	...
	$('#form_testo_pignoramento_presso_terzi').ajaxForm(
...
<table class="table_interna text_center" border="0" cellspacing="10" cellpadding="0">
	<tr>
		<td><font class="titolo font16 under_decor">Testo Pignoramento presso terzi</font></td>
	</tr>
</table>
...
<form name="testo_pignoramento_presso_terzi" id="form_testo_pignoramento_presso_terzi" action="testo_pignoramento_presso_terzi_salva.php" method="post">
...
<table class="table_interna text_center" border="0">
	...
	<tr>
		<td></td>
		<td></td>
		<td>Stampato se Datore di lavoro</td>
		<td></td>
	</tr>
	<tr>
		<td></td>
	...
	<tr>
		...
		<td>
			<textarea name="datore_lavoro" onkeyup="CheckCaratteri(name);" onchange="CheckCampiObbligatori();" style="width:95%" rows="7"><?=$Datore_Lavoro?></textarea>
		</td>
		<td>
			<font size=-2>
	...
	<tr>
		<td>
			<div id="ufficiale_datore_lavoro">Ufficiale Datore di lavoro:</div>
		</td>
		<td>
			<font size=-2>GIUS</font>
		</td>
		<td>
			<textarea name="ufficiale_datore_lavoro" onkeyup="CheckCaratteri(name);" onchange="CheckCampiObbligatori();" style="width:95%" rows="3"><?=$Ufficiale_Datore_Lavoro?></textarea>
		</td>
		<td>
			<font size=-2>
			{GESTORE}
	...
	<tr>
		<td>
			<div id="sottoposto_pignoramento_datore_lavoro">Sottoposto pignoramento datore di lavoro:</div>
		</td>
		<td>
			<font size=-2>GIUS</font>
		</td>
		<td>
			<textarea name="sottoposto_pignoramento_datore_lavoro" onkeyup="CheckCaratteri(name);" onchange="CheckCampiObbligatori();" style="width:95%" rows="8"><?=$Sottoposto_Pignoramento_Datore_Lavoro?></textarea>
		</td>
		<td>
			<font size=-2>
