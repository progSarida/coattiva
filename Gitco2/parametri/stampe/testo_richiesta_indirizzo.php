...
//PARAMETRI TESTO
$para_testo = new testo_richiesta_indirizzo(NULL);
$myId = $para_testo->CercaParametroData($c, date("Y-m-d"));
$testo = new testo_richiesta_indirizzo($myId);
...
function salva_form() 
{
	if (CheckCampiObbligatori () == true)
	{
		if (CheckTuttiCampi () == true)
		{
			...
			if(control_salva)
       			$("#form_testo_richiesta_indirizzo").submit();
		}
    }
}
...
function annulla() 
{
	...
	stringa = "testo_richiesta_indirizzo.php?"+stringaPHP;
...
function CheckCampiObbligatori ()
 {	
	...
	if (ParolaPresenteInStringa ("Motivazione", "{MOTIVAZIONERICHIESTA}") == false) return false;
	if (ParolaPresenteInStringa ("Contatti", "{FAXGESTORE}") == false) return false;
...
function CheckTuttiCampi ()
{
	...
	if (CheckCaratteri ("Motivazione") == false) return false;
	if (CheckCaratteri ("Richiesta_Utente") == false) return false;
	if (CheckCaratteri ("Richiesta_Siatel") == false) return false;
	if (CheckCaratteri ("Contatti") == false) return false;
	if (CheckCaratteri ("Informativa_Richiesta") == false) return false;
...
$(document).ready(function(){
	...
	$('#form_testo_richiesta_indirizzo').ajaxForm(
...
<table class="table_interna text_center" border="0" cellspacing="10" cellpadding="0">
	<tr>
		<td><font class="titolo font16 under_decor">Testo richiesta indirizzo</font></td>
	</tr>
</table>
...
<form name="testo_richiesta_indirizzo" id="form_testo_richiesta_indirizzo" action="testo_richiesta_indirizzo_salva.php" method="get">
...
<table class="table_interna text_center" border="0">
	...
	<tr>
		<td>
			<div id="Motivazione">Motivazione:</div>
		</td>
		<td>
			<font size=-2>CEN</font>
		</td>
		<td>
			<textarea name="Motivazione" onblur="CheckCaratteri(this);" onchange="CheckCampiObbligatori();" style="width:95%" rows="2"><?=$Motivazione?></textarea>
		</td>
		<td>
			<font size=-2>
	...
	<tr><td colspan=4>Se persona fisica</td></tr>
	<tr><td colspan=4><hr></td></tr>
	<tr>
		<td>
			<div id="Richiesta_Utente">Richiesta utente:</div>
		</td>
		<td>
			<font size=-2>CENT</font>
		</td>
		<td>
			<textarea name="Richiesta_Utente" onblur="CheckCaratteri(this);" onchange="CheckCampiObbligatori();" style="width:95%" rows="5"><?=$Richiesta_Utente?></textarea>
		</td>
		<td>
			<font size=-2>
			</font>
	...
	<tr><td colspan=4><hr></td></tr>
	<tr><td colspan=4>Se ditta</td></tr>
	<tr><td colspan=4><hr></td></tr>
	<tr>
		<td>
			<div id="Richiesta_Siatel">Richiesta SIATEL:</div>
		</td>
		<td>
			<font size=-2>CENT</font>
		</td>
		<td>
			<textarea name="Richiesta_Siatel" onblur="CheckCaratteri(this);" onchange="CheckCampiObbligatori();" style="width:95%" rows="8"><?=$Richiesta_Siatel?></textarea>
		</td>
		<td>
			<font size=-2>
			</font>
	...
	<tr>
		...
		<td>
			<textarea name="Contatti" onblur="CheckCaratteri(this);" onchange="CheckCampiObbligatori();" style="width:95%" rows="4"><?=$Contatti?></textarea>
		</td>
		<td>
			<font size=-2>
			{FAXGESTORE}
	...
	<tr>
		<td>
			<div id="Informativa_Richiesta">Informativa richiesta:</div>
		</td>
		<td>
			<font size=-2>GIUS</font>
		</td>
		<td>
			<textarea name="Informativa_Richiesta" onblur="CheckCaratteri(this);" onchange="CheckCampiObbligatori();" style="width:95%" rows="5"><?=$Informativa_Richiesta?></textarea>
		</td>
		<td>
			<font size=-2>
			</font>
