...
$a_para_Pag = $cls_db->getArrayLineNull($cls_db->ExecuteQuery($cls_param->Get_Query_Pagamento($c , $tipo_riscossione )),"parametri_pagamento");
...
*/
/*function control_autorizzazione()
{

	if(td_bollettino != "123" && td_bollettino != "")
	{
		$auth_data = $("#data_aut").val();
		$auth = $("#aut").val();
		$auth_data_2 =	$("#data_aut_2").val();
		$auth_2 = $("#aut_2").val();

		if($auth_data == "" )
		{
			swal("IL campo  Data Principale è obbligatorio!")
		}
		if($auth == "")
		{
			swal("IL campo  Autorizzazione Principale è obbligatorio!")
		}
		if($auth_data_2 == "")
		{
			swal("IL campo  Data Secondario è obbligatorio!")
		}
		if($auth_2 == "")
		{
			swal("IL campo Autorizzazione Secondario è obbligatorio!")
		}
...
function control_bollettino(value)
{
	if(value==1)
	{
		...
		/* 09/05/2022 - START */
		if(td_bollettino == "896")
		{
			$("#si_importo").prop('checked',true);
			$("#si_importo_pigno").prop('checked',true);
			$("#no_importo").prop('disabled',true);
			$("#no_importo_pigno").prop('disabled',true);
		}
		/* 09/05/2022 - END */
	...
	else
	{
		...
		if(td_bollettino == "896")
		{
			$("#si_importo_2").prop('checked',true);
			$("#si_importo_pigno_2").prop('checked',true);
			$("#no_importo_2").prop('disabled',true);
			$("#no_importo_pigno_2").prop('disabled',true);
		}
		/* 09/05/2022 - END */
...
switchMenuImg("F11");
        F11_button = function(){
			...
			$("#frameHelp").attr("src","<?= SUPER_WEB_ROOT."/archivio/help/Bollettini.pdf"; ?>");
            $("#helpModalLabel").empty().append("<b>Help Bollettini</b>");
...
<div class="row">
	...
	<div class="col col-lg-5 col-lg-offset-1">
		<div class="form-group">
			...
			<div class="col-lg-7 col-lg-offset-1">
					<input style="width: 78%;" class="form-control resize" name=bic_conto id=bic_conto	value="<?php echo $a_para_Pag["BICSWIFT"]; ?>" >
			</div>
		</div>
	</div>
</div>
<div class="row">
	...
	<div class="col col-lg-5 col-lg-offset-1">
		<div class="form-group">
			...
			<div class="col-lg-7 col-lg-offset-1">
					<input style="width: 78%;" class="form-control vld_date resize picker" type="text" name=data_cambio id=data_cambio value="<?php echo $dataCambioConto->GetDate("IT"); ?>" >
			</div>
		</div>
	</div>
</div>
...
<div class="row">
	<div class="col col-lg-10 col-lg-offset-1">
		<div class="form-group">
			...
			<div class="col-lg-5 resize text_left resize">
			<!-- GV - 09/05/2022 -   END -->	
...
<div class="row">
	<div class="col col-lg-10 col-lg-offset-1">
		<div class="form-group">
			...
			<label class="col-lg-2 control-label resize" style="text-align: left;">Stemma<img title="<?php echo $info1;?>" src="<?= IMMAGINIWEB; ?>/info.png"  width=18 height=18 border=0></label>
			<div class="col-lg-9 resize text_left">	
			<!-- GV - 09/05/2022 -   END -->
...
<div class="row">
	<div class="col col-lg-10 col-lg-offset-1">
		<div class="form-group">
			...
			<div class="col-lg-8 resize text_left" -->
			<label class="col-lg-2 control-label resize" style="text-align: left;">Stemma 2<img title="<?php echo $info2;?>" src="<?= IMMAGINIWEB; ?>/info.png" width=18 height=18 border=0></label>	
			<div class="col-lg-9 resize text_left">
			<!-- GV - 09/05/2022 - END -->	
...
<div class="row">
	<div class="col col-lg-10 col-lg-offset-1">
		<div class="form-group">
			<label class="col-lg-5 control-label resize" style="text-align: left;">Scadenza Cautelari</label>
			<div class="col-lg-3 ">
				<input class="form-control vld_intReq resize" style="width: 30%" type="text" name=scadenza_cautelari id=scadenza_cautelari value="<?php echo $a_para_Pag["Scadenza_Cautelari"]; ?>" >
			</div>
			<div class="col-lg-4 resize">giorni dalla data di notifica dell'atto </div>
		</div>
	</div>
