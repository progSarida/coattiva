...
{
	window.open('/gitco2/stampe/conferma_indirizzo.php?ID_Atto=153&tipo_richiesta='+value+'&a=<?php echo $a; ?>&c=<?php echo $c; ?>');
}
...
<div class="row">
	<div class="col col-lg-3 col-lg-offset-1">
		<div class="form-group">
			...
			<div class="col-lg-8">
				<input class="form-control resize validateCustom vld_Custom_r" title="Clicca sul campo 'Comune' per effettuare la ricerca dell'ufficio di interesse" style="background-color: rgb(153, 204, 255); border: 2px solid black;" readonly name=comune id=comune_id value="" onclick="cerca_comune();">
			</div>
		</div>
	</div>
...
<div class="row">
	<div class="col col-lg-3 col-lg-offset-1">
		<div class="form-group">
			...
			<div class="col-lg-8">
				<input class="form-control resize validateCustom vld_Custom_r" title="Clicca sul campo 'Sede ufficio' per inserire il comune sede dell'ufficio" style="background-color: rgb(153, 204, 255); border: 2px solid black;" readonly name=comune_sede id=comune_sede_id value="" onclick="cerca_sede();">
			</div>
		</div>
	</div>
