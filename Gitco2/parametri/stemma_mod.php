...
// if($stemma_4!="")
// {
// 	$img_stemma_4 = new Imagick($path_4);
// 	$d = $img_stemma_4->getImageGeometry();
// 	$w_img4 = $d['width'];
// 	$h_img4 = $d['height'];
// 	$border[4] = 1;
// }
...
$(document).ready(function(){
    ...
    if("<?php echo $w_img1; ?>">0)
	    dimensiona_magnify("1", "<?php echo $w_img1; ?>" , "<?php echo $h_img1; ?>" , 150, 150 );
...
<table class="table_interna text_center" border="0" cellspacing="4" cellpadding="0">
	<tr>
		<td class="text_center" colspan=4><span class="color_titolo">ENTE</span></td>
	</tr>
	<tr>
		<td class="text_center" colspan=4><hr></td>
	</tr>
	<tr>
		<td class="text_left width15"><b>Principale</b></td>
		<td class="text_left width50"><input class="button_azzurro width100" type="file" name="stemma_1" value="Carica immagine"></td>
		<td class="text_left width35" colspan=2>
			<div id=mostra_immagine class="image-magnify1" title="Clicca per allargare immagine" onclick="window.open('<?php echo $stemma_1; ?>')">
				<div class="thumbnail1 text_center">
					<img id="thumbnail_image1" src="<?php echo $stemma_1; ?>" border="<?php echo $border[1]; ?>">
