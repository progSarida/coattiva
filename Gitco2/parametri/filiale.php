...
F11_button = function(){
    ...
    $("#frameHelp").attr("src","<?= SUPER_WEB_ROOT."/archivio/help/Filiali_Banche.pdf"; ?>");
    $("#helpModalLabel").empty().append("<b>Help Filiali Banche</b>");
...
function openOfcanvas(type,rif){
    switch (type){
        case 'citySearchModal':                                     // ricerca comune
            ...
            break;
        case 'bankSearchModal':                                     // ricerca sede/filiale
            // Reset campi input
            $('#bank_n').val("");
            $('#bank_c').val("");
            $('#bank_cap').val("");
            ...
            break;
        case 'bankSearchModalB':                                    // ricerca solo filiale
            // Reset campi input
            $('#bank_n').val("");
            $('#bank_c').val("");
            $('#bank_cap').val("");
            // Gestione radio
            $('#bank_headq').prop('checked', false);
            $('#bank_branch').prop('checked', true);
            $('#bank_headq').attr("disabled", true);                // blocca radio sede
            // Reset spazi tabella
            $('#appendTableBank').empty();
            // Inizializzazione campo 'Denominazione'
            $('#bank_n').val($('#denom_sede_id').val());
            // Apertura modale
            selectRif = rif;
            $('#bankSearchModal').modal('show')
            break;
...
<div class="row">
	<div class="col col-lg-4 col-lg-offset-1">
		<div class="form-group">
			...
			<div class="col-lg-8">
				<input readonly style="background-color: #97CFDD; border: 2px solid black;" class="text_left form-control resize vld_req" id=denom_sede_id name=denom_sede value="<?php echo $a_param_sede["Denominazione"]; ?>" >
			</div>
		</div>
	</div>
	<div class="col col-lg-3">
		<div class="form-group">
			<div class="col-lg-12">
				<select readonly style="background-color: #97CFDD; border: 2px solid black;" id=forma_giuridica_sede class="form-control resize vld_req" name=forma_giuridica_sede onchange="cambia_title('forma_giuridica_sede');">
					<option></option>
	...
	<div class="col col-lg-2">
		<div class="form-group">
			<div class="col-lg-10 col-lg-offset-2">
				<button class="btn btn-primary form-control resize" type=button id=cerca_banca name=cerca_banca value="Sede / Filiale" onclick="/*ricerca_banca('');*/openOfcanvas('bankSearchModal',0);">Sede / Filiale</button>
			</div>
		</div>
	</div>
</div>
...
<div class="row">
	<div class="col col-lg-4 col-lg-offset-1">
		<div class="form-group">
			...
			<div class="col-lg-8">
				<input readonly style="background-color: #97CFDD; border: 2px solid black;" class="form-control resize vld_PIReq" id=PI_id name=PI value="<?php echo $a_param_sede["Partita_Iva"]; ?>" >
			</div>
		</div>
	</div>
	<div class="col col-lg-3">
		<div class="form-group">
			...
			<div class="col-lg-8">
				<input readonly style="background-color: #97CFDD; border: 2px solid black;" class="form-control resize" id=CF_id name=CF value="<?php echo $a_param_sede["Codice_Fiscale"]; ?>" >
			</div>
		</div>
	</div>
</div>
...
<div class="row" style="margin-bottom:1%;">
	<div class="col col-lg-4 col-lg-offset-4" style="text-align:center;">
...
<?php if(is_numeric($id_sede)): ?>
	...
	<div class="row">
		...
		<div class="col col-lg-2">
			<div class="form-group">
				<div class="col-lg-10 col-lg-offset-2">
					<button class="btn btn-primary form-control resize" type=button id=cerca_banca name=cerca_banca value="Filiale" onclick="/*ricerca_banca('filiale');*/openOfcanvas('bankSearchModalB',0);">Filiale</button>
				</div>
			</div>
		</div>
	</div>
	...
	<div class="row">
		<div class="col col-lg-3 col-lg-offset-1">
			<div class="form-group">
				...
				<div class="col-lg-8">
					<input class="form-control resize validateCustom vld_Custom_r" style="background-color: rgb(153, 204, 255); border: 2px solid black;" readonly tabindex=1 name=comune id=comune_id value="<?php echo $a_param["Comune"]; ?>" ondblclick="/*cerca_comune('tribunale');*/openOfcanvas('citySearchModal',0);">
				</div>
			</div>
		</div>
		<div class="col col-lg-2">
