...
$a_param = $cls_db->getArrayLine($cls_db->ExecuteQuery($cls_param->Get_Query_Annuali($c , $anno_par)));
		...
		<div class="row justify-content-lg-center">
			<div class="col col-lg-5 col-lg-offset-1">
				<div class="form-group">
			      ...
			      <div class="col-lg-3">
			          <input style="width: 60%;" class="text_right form-control vld_decReq resize" name=spese_ing id=spese_ing_id type="text" value="<?php echo $cls_param->conv_num($spese_ing); ?>">
						</div>
		...
		<div class="row justify-content-lg-center">
			<div class="col col-lg-5 col-lg-offset-1">
				<div class="form-group">
			      ...
			      <div class="col-lg-3">
			          <input style="width: 60%;" type="text" class="form-control resize text_right vld_decReq" name=a_mani id=a_mani_id value="<?php echo $cls_param->conv_num($a_mani); ?>" />
						</div>
		...
		<div class="row justify-content-lg-center">
			<div class="col col-lg-5 col-lg-offset-1">
				<div class="form-group">
			      <label class="col-lg-4 control-label resize"><b>Spese notifica</b> (&euro;)</label>
			      <div class="col-lg-3">
			          <input type="text" style="width: 60%;" class="resize text_right form-control vld_decReq " name=spese_pigno id=spese_pigno_id value="<?php echo $cls_param->conv_num($spese_pigno); ?>">
						</div>
						<div class="col-lg-5 resize">CONSIGLIATO<br>Spese postali + CAD</div>
				</div>
			</div>
		...
		<div class="row justify-content-lg-center">
			<div class="col col-lg-5 col-lg-offset-1">
				<div class="form-group">
			      <label class="col-lg-4 control-label resize"><b>Consegna a mani</b> (&euro;)</label>
			      <div class="col-lg-3">
			          <input style="width: 60%;" class="resize text_right form-control vld_decReq" name=a_mani_pigno id=a_mani_pigno_id value="<?php echo $cls_param->conv_num($a_mani_pigno); ?>" type="text" >
						</div>
						<div class="col-lg-5 resize">( Importo forfettario )</div>
				</div>
			</div>
		...
		<div class="row justify-content-lg-center">
			<div class="col col-lg-5 col-lg-offset-1">
				<div class="form-group">
			      ...
			      <div class="col-lg-3">
			          <input type="text" style="width: 60%;" class="resize text_right form-control vld_decReq" name=spese_post id=spese_post_id value="<?php echo $cls_param->conv_num($spese_post); ?>" />
						</div>
		...
		<div class="row justify-content-lg-center">
			<div class="col col-lg-5 col-lg-offset-1">
				<div class="form-group">
			      ...
			      <div class="col-lg-3">
			          <input style="width: 60%;" class="resize text_right form-control vld_decReq" name=spese_racc id=spese_racc_id value="<?php echo $cls_param->conv_num($spese_racc); ?>" />
						</div>
						<div class="col-lg-5"></div>
				</div>
			</div>
		...
		<div class="row justify-content-lg-center">
			<div class="col col-lg-5 col-lg-offset-1">
				<div class="form-group">
			      ...
			      <div class="col-lg-3">
			          <input style="width: 60%;" class="resize text_right form-control vld_decReq" name=spese_post_ag id=spese_post_ag_id value="<?php echo $cls_param->conv_num($spese_post_ag); ?>" type="text" />
						</div>
						<div class="col-lg-5 resize">( Importo forfettario )</div>
				</div>
			</div>
		...
		<div class="row justify-content-lg-center">
			<div class="col col-lg-5 col-lg-offset-1">
				<div class="form-group">
						...
						<div class="col-lg-3">
								<input style="width: 60%;" class="resize text_right form-control vld_decReq" name=cad id=cad_id value="<?php echo $cls_param->conv_num($cad); ?>" type="text" />
						</div>
						<div class="col-lg-5"></div>
				</div>
			</div>
		...
		<div class="row justify-content-lg-center">
			<div class="col col-lg-5 col-lg-offset-1">
				<div class="form-group">
			      ...
			      <div class="col-lg-3">
			          <input style="width: 60%;" class="resize text_right form-control vld_decReq" name=can id=can_id value="<?php echo $cls_param->conv_num($can); ?>" type="text" />
						</div>
						<div class="col-lg-5"></div>
				</div>
			</div>
		...
		<div class="row justify-content-start" >
			<div class="col-lg-8 col-lg-offset-1">
				<div class="form-group">
					...
					<div class="col-lg-2">
							<input style="width: 60%;" class="resize text_right form-control vld_decReq" name=diritto_minimo id=diritto_minimo value="<?php echo $cls_param->conv_num($diritto_riscossione_minimo); ?>" />
					</div>
		...
		<div class="row justify-content-start" >
			<div class="col-lg-8 col-lg-offset-1">
				<div class="form-group">
					...
					<div class="col-lg-2">
							<input style="width: 60%;" class="resize text_right form-control vld_decReq" name=diritto_massimo id=diritto_massimo value="<?php echo $cls_param->conv_num($diritto_riscossione_massimo); ?>" type="text" />
					</div>
		...
		<div class="row" style="padding-top: 1%;">
			<div class="col-lg-10 col-lg-offset-1">
				<div class="form-group" >
					...
					<div class="col-lg-2">
							<input style="width: 60%;" class="resize text_right form-control vld_decReq" name=importo_min id=importo_min_id value="<?php echo $cls_param->conv_num($importo_min); ?>" type="text" />
					</div>
		...
		<div class="row" style="padding-top: 1%;">
			<div class="col col-lg-5 col-lg-offset-1">
				<div class="form-group">
			      ...
			      <div class="col-lg-2">
			          <input class="resize text_right form-control vld_decReq" name=ric_spese id=spese_ric_id value="<?php echo $cls_param->conv_num($ric_spese); ?>" type="text" />
						</div>
