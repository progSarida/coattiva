...
<div id=gestore style="margin-top: 1%;">
	...
	<div class="row justify-content-md-center ">
	<div class="col col-md-auto text_center">
			<p class="titolo font16 under_decor">Dati Rimborso Spese</p>
	</div>
	</div>
	<div class="row">
		<div class="col col-lg-3 col-lg-offset-1">
			<div class="form-group">
				...
				<div class="col-lg-8">
					 <input class="text_left form-control resize" id=Intestatario_id name=Intestatario size=18 value="<?php echo $a_enteAdmin["Gestore_Intestatario"]; ?>" >
			  </div>
			</div>
		</div>
		<div class="col col-lg-4">
			<div class="form-group">
				...
				<div class="col-lg-8">
					 <input class="text_left form-control resize" style="width: 85%;" id=Conto_Corrente_id name=Conto_Corrente value="<?php echo $a_enteAdmin["Gestore_Conto_Corrente"]; ?>" >
				</div>
			</div>
		</div>
		<div class="col col-lg-3">
			<div class="form-group">
				...
				<div class="col-lg-8">
					 <input class="text_left form-control vld_IBAN" id=IBAN_id name=IBAN size=16 value="<?php echo $a_enteAdmin["Gestore_IBAN"]; ?>" >
				</div>
			</div>
		</div>
	</div>
	<div class="row">
		<div class="col col-lg-3 col-lg-offset-1" >
			<div class="form-group">
				<label class="col-lg-6 control-label resize">Scadenza Giorno</label>
				<div class="col-lg-3">
					 <input type="text" id=Scadenza_Giorno class="text_right form-control resize vld_int"  name="Scadenza_Giorno" 	value="<?php if($a_enteAdmin["Gestore_Scadenza_Giorno"]<10) echo "0";echo $a_enteAdmin["Gestore_Scadenza_Giorno"]; ?>" >
				</div>
			</div>
		</div>
		<div class="col col-lg-5">
			<div class="form-group">
				<label class="col-lg-4 control-label resize">Scadenza Mese</label>
				<div class="col-lg-2">
					 <input type="text" id=Scadenza_Mese class="text_right form-control resize vld_int"  name="Scadenza_Mese" value="<?php if($a_enteAdmin["Gestore_Scadenza_Mese"]<10) echo "0";echo $a_enteAdmin["Gestore_Scadenza_Mese"]; ?>" >
				</div>
			</div>
		</div>
	</div>
