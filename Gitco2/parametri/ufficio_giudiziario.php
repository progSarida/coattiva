...
F11_button = function(){
    ...
    $("#frameHelp").attr("src","<?= SUPER_WEB_ROOT."/archivio/help/Autorita.pdf"; ?>");
    $("#helpModalLabel").empty().append("<b>Help Autorità</b>");
...
<div class="row">
	<div class="col col-lg-3 col-lg-offset-1">
		<div class="form-group">
			...
			<div class="col-lg-8">
					<input class="text_left form-control resize" style="background-color: rgb(153, 204, 255); border: 2px solid black;" readonly tabindex=1 name=comune id=comune_id value="<?php echo $a_comune["Comune"]; ?>" ondblclick="/*cerca_comune();*/openOfcanvas('citySearchModal',0);">
			</div>
		</div>
	</div>
	...
	<div class="col col-lg-3">
		<div class="form-group">
			...
			<div class="col-lg-8" >
					<input class="text_left width100 form-control resize" id=sezione_id name=sezione value="<?php echo $a_comune["Sezione"]; ?>" tabindex=4>
			</div>
		</div>
	</div>
</div>
...
<div class="row">
	...
	<div class="col col-lg-1">
		<div class="form-group">
			...
			<div class="col-lg-8" >
				<input type="text" id=interno class="form-control resize vld_int"  name="interno" 	value="<?php echo $int; ?>"  size=2 tabindex=8>
			</div>
		</div>
	</div>
	<div class="col col-lg-3">
