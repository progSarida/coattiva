...
$para = new parametri_pignoramento( $c );
$par_id = $para->ID;
...
function annulla()
{
	location.href="par_pignoramento.php?c=<?php echo $c; ?>&a=<?php echo $a; ?>";
}
...
$(document).ready(function(){
	...
	$('#form_par_pignoramento').ajaxForm(
...
<table class="table_interna text_center" border="0" cellspacing="10" cellpadding="0">
	<tr>
		<td><font class="titolo font16 under_decor">Parametri pignoramenti</font></td>
	</tr>
</table>
<br>

<form name=form_par_pignoramento id=form_par_pignoramento method=post action="par_pignoramento_salva.php">
...
<table class="table_interna text_center" border="0" cellspacing="4" cellpadding="0">
	<tr>
		<td class="text_center" colspan=5><b>Protocollo</b></td>
	</tr>
	<tr>
		<td class="text_center" colspan=5><hr></td>
	</tr>
	<tr>
		<td class="text_left width20">Tipo</td>
		<td class="text_center width20"><input type="radio" name=tipo_protocollo value="" onclick="change_prot()" checked> Assente</td>
		<td class="text_center width20"><input type="radio" name=tipo_protocollo value="progressivo" onclick="change_prot()"> Progressivo</td>
		<td class="text_center width20"><input type="radio" name=tipo_protocollo value="fisso" onclick="change_prot()"> Fisso</td>
