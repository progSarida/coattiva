...
<form class="form-horizontal validate" name=form_par_email id=form_par_email method=post action="par_email_salva.php">
	...
	<div class="row justify-content-md-center ">
		<div class="col col-md-auto text_center">
				<p class="titolo font16 under_decor">Parametri autenticazione eMail (<?php echo $titolo_riscossione; ?>)</p>
		</div>
	</div>
	<div class="row justify-content-md-center ">
		<div class="col col-md-auto text_center">
