...
if($Authority_ID == null)
    ...
    $a_authority = $cls_db->getArrayLine($cls_db->SelectQuery($cls_authority->getAuthorityquery($Authority_ID)));
...
<div class="row">
	<div class="col col-lg-3 col-lg-offset-1">
		<div class="form-group">
			...
			<div class="col-lg-8">
        <input type="button" class="form-control resize btn btn-primary" value="Ricerca" onclick="searchAuthority();">
			</div>
		</div>
	</div>
...
<div class="row">
	<div class="col col-lg-3 col-lg-offset-1">
		<div class="form-group">
			...
			<div class="col-lg-8">
        <input class="form-control resize validateCustom vld_Custom_r" style="background-color: rgb(153, 204, 255); border: 2px solid black;" readonly name=Comune id=comune_id value="<?php echo $a_authority['Comune'];?>" onclick="searchMunicipality();">
			</div>
		</div>
	</div>
