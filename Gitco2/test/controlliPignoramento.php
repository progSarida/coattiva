...
if(empty($_GET['DocumentTypeId']))  
    $_GET['DocumentTypeId']= 22;

require $_SERVER['DOCUMENT_ROOT'].explode("/Gitco2",$_SERVER['SCRIPT_NAME'])[0]."/config/_config.php";

include(INC . "/headerAjax.php");
include_once CLS . "/cls_db.php";
include_once "cls_testElaborationPigno.php";

$cls_db = new cls_db();

echo "<pre>TEST CONTROLLI PIGNORAMENTI<hr></pre>";

$query_partita = " SELECT * FROM v_check_pignoramenti WHERE ";
if(!empty($_GET['Partita_ID']))
...
$cls_elaboration = new cls_testElaborationPigno($a_params);
