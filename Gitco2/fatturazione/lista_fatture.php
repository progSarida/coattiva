...
$questaPagina = "lista_fatture.php";
...
$queryTutteFatture = "SELECT fatture_generali.ID as IDFG FROM fatture_generali ";
$queryTutteFatture .= " LEFT JOIN fatture_dati_cig ";
$queryTutteFatture .= " on fatture_generali.Fat_Dati_Cig = fatture_dati_cig.ID WHERE Fat_Societa='".$aSocieta[$id]."' ";
...
$rossoAnnoC = $rossoAnnoB = $rossoAccredito = $rossoRisc = $rossoGest = "";
switch ($ordinamento)
{
	case 1: $metodoOrd = " Fat_Numero "; $rossoNum = " color_red "; break;
	case 2: $metodoOrd = " Fat_Anno_Competenza $direzione, Fat_Comune, Fat_Numero "; $rossoAnnoC = " color_red "; break;
	case 3: $metodoOrd = " Fat_Comune $direzione, Fat_Numero "; $rossoCom = " color_red "; break;
	case 4: $metodoOrd = " Fat_Tipo $direzione, Fat_Numero "; $rossoTipo = " color_red "; break;
	case 5: $metodoOrd = " Tipo_Tributo $direzione, Fat_Numero "; $rossoRisc = " color_red "; break;
	case 6: $metodoOrd = " Tipo_Gestione $direzione, Fat_Numero "; $rossoGest = " color_red "; break;
	case 7: $metodoOrd = " Fat_Totale $direzione, Fat_Data "; $rossoImporto = " color_red "; break;
	case 8: $metodoOrd = " Fat_Data $direzione, Fat_Numero "; $rossoData = " color_red "; break;
	case 9: $metodoOrd = " Fat_Anno_Bilancio $direzione, Fat_Comune ASC, Fat_Numero "; $rossoAnnoB = " color_red "; break;
	case 10: $metodoOrd = " Fat_Accredito "; $rossoAccredito = " color_red "; break;
...
{
	var stringaLink = "fatture.php?";
	stringaLink += "c=" + "<?php echo $c?>";
	stringaLink += "&a=" + "<?php echo $a?>";
	stringaLink += "&operazione=" + "CARICANUOVA";
	stringaLink += "&numerooperazione=" + value;
	location.href = stringaLink;
}
...
<?php include FATTURAZIONE . '/menu/menu_fatturazione.php'; ?>
	...
	<form id="lista_form" name="lista_form" action="<?=$questaPagina?>" method="get">
 	...
 	<table class="table_interna text_center" border=0 style="border:3px solid #6D95D5;">
		<tr class="pheight50">
			...
			<td class="width70 text_center">
				<font class="titolo font18">LISTA FATTURE</font>
			</td>
			<td class="width15 text_center">
				Pagina
	...
	<table class='table_interna text_center' border='0' cellpadding="0" cellspacing="0">
	<tr class="pheight30 sfondo_new_gitco">
		<td class="width8 text_center" colspan="2">
			
		</td>
		<td class="width15 text_center">
			<font class="font_bold fontlink font11 <?php echo $rossoNum ?>" title="Ordina" onclick="Ordiniamo(1);">Numero Fattura</font> 
		</td>
		<td class="width7 text_center">
			<font class="font_bold fontlink font11 <?php echo $rossoAnnoC ?>" title="Ordina" onclick="Ordiniamo(2);">Comp.</font>
		</td>
		<td class="width25 text_center">
			<font class="font_bold fontlink font11 <?php echo $rossoCom ?>" title="Ordina" onclick="Ordiniamo(3);">CC</font>
		</td>
		<td class="width10 text_center">
			<font class="font_bold fontlink font11 <?php echo $rossoTipo ?>" title="Ordina" onclick="Ordiniamo(4);">Tipo</font>
		</td>
		<td class="width10 text_center">
			<font class="font_bold fontlink font11 <?php echo $rossoRisc ?>" title="Ordina" onclick="Ordiniamo(5);">Riscossione</font>
		</td>
		<td class="width10 text_center">
			<font class="font_bold fontlink font11 <?php echo $rossoGest ?>" title="Ordina" onclick="Ordiniamo(6);">Gestione</font>
		</td>
		<td class="width10 text_center">
			<font class="font_bold fontlink font11 <?php echo $rossoImporto ?>" title="Ordina" onclick="Ordiniamo(7);">Importo</font>
		</td>
		<td class="width5 text_center">
			<font class="font_bold fontlink font11">Esito</font>
		</td>
	</tr>
	<tr class="pheight30 sfondo_new_gitco_simile">
		<td class="text_center" colspan="2">
			 
		</td>
		<td class="text_center">
			<font class="font_bold fontlink font11 <?php echo $rossoData ?>" title="Ordina" onclick="Ordiniamo(8);">Data</font> 
		</td>
		<td class="text_center">
			<font class="font_bold fontlink font11 <?php echo $rossoAnnoB ?>" title="Ordina" onclick="Ordiniamo(9);">Bil.</font>
		</td>
		<td class="text_center" colspan="4">
			<font class="font_bold font11">Descrizione</font>
		</td>
		<td class="text_center">
			<font class="font_bold fontlink font11 <?php echo $rossoAccredito ?>" title="Ordina" onclick="Ordiniamo(10);">Accredito</font>
		</td>
		<td class="text_center">
	...
	$contoPerPagina = 0;
	$fattureGenerali = array();
	while ($rigaEmail = risultati_query($resTutteFatture))
	{
		if ($contoPerPagina >= $partenza)
		{
			$fattureGenerali[] = $rigaEmail['IDFG'];
		}
		if (count($fattureGenerali) > $ultimo) break;
		$contoPerPagina++;
	}
	
	$destinazioneEmail = crea_dir($PathCompletoFatture . "/PEC/");
	for ($kkk = 0; $kkk < count($fattureGenerali); $kkk++)
	{
		...
		$myGenFattura = new fatture_generali($fattureGenerali[$kkk]);
		
		$idFattura = $myGenFattura->ID;
		$numFattura = $myGenFattura->Fat_Numero;
		$esplodoBarre = explode("/", $numFattura);
		$numFattura = "<font class='color_red font_bold'>" . $esplodoBarre[0] . "</font>";
		$numFattura .= "/" . $esplodoBarre[1];
		$numFattura .= "/" . $esplodoBarre[2];
		
		$annoBilancio = $myGenFattura->Fat_Anno_Bilancio;
		$annoCompetenza = $myGenFattura->Fat_Anno_Competenza;
		
		$myCom = new fatture_dati_sedi_comuni(null);
		$comuneFatt = $myCom->NomeComuneDaCCFatture($myGenFattura->Fat_Comune);
		
		$tipoFattura = $myGenFattura->Fat_Tipo;
		
		$myDati = new fatture_dati_cig($myGenFattura->Fat_Dati_Cig);
		$riscossioneFattura = $myDati->Tipo_Tributo;
		$gestioneFattura = $myDati->Tipo_Gestione;
		
		$totaleFattura = number_format($myGenFattura->Fat_Totale, 2, ",", ".");
		
		$dataFattura = from_mysql_date($myGenFattura->Fat_Data);
		
		$testoFattura = $myGenFattura->Fat_Testo_Da_A_Periodo;
		$accreditoFattura = number_format($myGenFattura->Fat_Accredito, 2, ",", ".");
		
		$myInvio = new fatture_invii(null);
		$idInvio = $myInvio->CercaInvioDaFattura($myGenFattura->ID);
		...
		$htmlImg = "<img src='$iconaEmail' class='pwidth15 pheight15' title='$statoEmail'>";
		...
		?>
			...
			<tr class="pheight25 <?=$stileriga?>">
				<td class="text_center" rowspan="2">
					<img src="/gitco2/immagini/Plus.png" class="pwidth15 pheight15" alt="Clicca qui per inserire la selezione" onClick="Seleziona(<?=$idFattura?>);">
				</td>
				<td class="text_center" rowspan="2">
					<font class="font11"><?=$idFattura?></font>
				</td>
				<td class="text_center">
					<font class="font14"><?=$numFattura?></font>
				</td>
				<td class="text_center">
					<font class="font11"><?=$annoCompetenza?></font>
				</td>
				<td class="text_center">
					<font class="font11"><?=$comuneFatt?></font>
				</td>
				<td class="text_center">
					<font class="font11 font_bold"><?=$tipoFattura?></font>
				</td>
				<td class="text_center">
					<font class="font11"><?=$riscossioneFattura?></font>
				</td>
				<td class="text_center">
					<font class="font9"><?=$gestioneFattura?></font>
				</td>
				<td class="text_right">
					<font class="font11 font_bold"><?=$totaleFattura?></font>
				</td>
				<td class="text_center" rowspan="2">
					<font class="font11"><?=$htmlImg?></font>
				</td>
			</tr>
			<tr class="pheight25 <?=$stileriga?>">
				<td class="text_center">
					<font class="font11"><?=$dataFattura?></font>
				</td>
				<td class="text_center">
					<font class="font11"><?=$annoBilancio?></font>
				</td>
				<td class="text_center" colspan="4">
					<font class="font11"><?=$testoFattura?></font>
				</td>
				<td class="text_right">
					<font class="font11"><?=$accreditoFattura?></font>
				</td>
			</tr>
