...
<script>
var index = "";                                                                        // Riferimento per sapere in quale campo inserire valori da ricerca

//Apertura modale
function openOfcanvas(ind){
    // Reset della modale
    $('#city').val("");                                                           // Svuoto campo ricerca nella modale
    $('#appendTableCity').empty();                                                // Svuoto risultato richiesta DB nella modale
    // Apro modale
    switch (ind){
        case 1:
            index = 1;                                                            // Inserire scelta nel form 1
            $('#citySearchModal').modal('show');
            break;
        case 2:
            index = 2;                                                            // Inserire scelta nel form 2
            $('#citySearchModal').modal('show');
            break;
        case 3:
            index = 3;                                                            // Inserire scelta nel form 3
            $('#citySearchModal').modal('show');
            break;
        case 4:
            index = 4;                                                            // Inserire scelta nel form 4
            $('#citySearchModal').modal('show');
            break;
        case 5:
            index = 5;                                                            // Inserire sceltanel form 5
            $('#citySearchModal').modal('show');
            break;
    }
}

//Inserimento dati da modale a pagina
        ...
        case "city":
            ...
            if ($.isEmptyObject(val)===false){
                switch (index){
                    case 1:
                        //alert("Inserimento 1");
                        $('#comune_1').val(val["nome"]);
                        $('#CC_1').val(val["CC_C"]);
                        //alert($('#CC_1').val());
                        //document.getElementById("comune_1").dispatchEvent(new Event("change"));
                        break;
                    case 2:
                        //alert("Inserimento 2");
                        $('#comune_2').val(val["nome"]);
                        $('#CC_2').val(val["CC_C"]);
                        //document.getElementById("comune_2").dispatchEvent(new Event("change"));
                        break;
                    case 3:
                        //alert("Inserimento 3");
                        $('#comune_3').val(val["nome"]);
                        $('#CC_3').val(val["CC_C"]);
                        //document.getElementById("comune_3").dispatchEvent(new Event("change"));
                        break;
                    case 4:
                        //alert("Inserimento 4");
                        $('#comune_4').val(val["nome"]);
                        $('#CC_4').val(val["CC_C"]);
                        //document.getElementById("comune_4").dispatchEvent(new Event("change"));
                        break;
                    case 5:
                        //alert("Inserimento 5");
                        $('#comune_5').val(val["nome"]);
                        $('#CC_5').val(val["CC_C"]);
                        //document.getElementById("comune_5").dispatchEvent(new Event("change"));
                        break;
                }
            }
            break;
...
<div class="row">
	<div class="col col-lg-5 col-lg-offset-1">
		<div class="form-group">
			...
			<div class="col-lg-8">
				<input class="form-control resize" style="background-color: rgb(153, 204, 255); border: 2px solid black;" type=text name=comune_1 readonly id=comune_1 size=20 ondblclick="/*ricerca_comune(1);*/openOfcanvas(1);" tabindex=3>
			</div>
		</div>
	</div>
</div>
...
<div class="row ente_2 ente_3 ente_4 ente_5">
	<div class="col col-lg-5 col-lg-offset-1">
		<div class="form-group">
			<label class="col-lg-4 control-label resize" style="text-align: left;">Comune</label>
			<div class="col-lg-8">
				<input class="form-control resize" style="background-color: rgb(153, 204, 255); border: 2px solid black;" type=text name=comune_2 readonly id=comune_2 size=20 ondblclick="/*ricerca_comune(2);*/openOfcanvas(2);" tabindex=4>
			</div>
		</div>
	</div>
</div>
...
<div class="row ente_3 ente_4 ente_5">
	<div class="col col-lg-5 col-lg-offset-1">
		<div class="form-group">
			<label class="col-lg-4 control-label resize" style="text-align: left;">Comune</label>
			<div class="col-lg-8">
				<input class="form-control resize" style="background-color: rgb(153, 204, 255); border: 2px solid black;" type=text name=comune_3 readonly id=comune_3 size=20 ondblclick="/*ricerca_comune(3);*/openOfcanvas(3);" tabindex=5>
			</div>
		</div>
	</div>
</div>
...
<div class="row ente_4 ente_5">
	<div class="col col-lg-5 col-lg-offset-1">
		<div class="form-group">
			<label class="col-lg-4 control-label resize" style="text-align: left;">Comune</label>
			<div class="col-lg-8">
				<input class="form-control resize" style="background-color: rgb(153, 204, 255); border: 2px solid black;" type=text name=comune_4 readonly id=comune_4 size=20 ondblclick="/*ricerca_comune(4);*/openOfcanvas(4);" tabindex=6>
			</div>
		</div>
	</div>
</div>
...
<div class="row ente_5">
	<div class="col col-lg-5 col-lg-offset-1">
		<div class="form-group">
			<label class="col-lg-4 control-label resize" style="text-align: left;">Comune</label>
			<div class="col-lg-8">
				<input class="form-control resize" style="background-color: rgb(153, 204, 255); border: 2px solid black;" type=text name=comune_5 readonly id=comune_5 size=20 ondblclick="/*ricerca_comune(5);*/openOfcanvas(5);" tabindex=7>
			</div>
		</div>
	</div>
</div>
