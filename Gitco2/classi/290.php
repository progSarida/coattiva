...
class N2
{
	...
	public function __construct( $progr )
	{
		...
		$this->Flag_Ingiunzione = utf8_decode($val['Flag_Ingiunzione']);
...
class N4
{
	...
	public function __construct( $progr )
	{
		...
		$this->Flag_Importazione = utf8_decode($val['Flag_Importazione']);
		$this->Flag_Maggiorazione = utf8_decode($val['Flag_Maggiorazione']);
