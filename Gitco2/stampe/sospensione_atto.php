...
<div class="row justify-content-md-center ">
    <div class="col col-md-auto text_center">
        <p class="titolo font16 under_decor">Stampa sospensione atti</p>
    </div>
</div>
	
<!-- <form id="sospensione_form" name="sospensione_form" action="stampa_sospensione_atto.php" method="post" target="stampa" onSubmit="window.open('', 'stampa', 'width=800,height=500,top=70,left=70,scrollbars=yes,menubar=no')"> -->
<form id="sospensione_form" name="sospensione_form" action="stampa_sospensione_atto.php">
