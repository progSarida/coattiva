...
$query = "SELECT UserName FROM ini_pec_processing WHERE UserId = '".$_SESSION['aut_progr']."'";
$result = $cls_db->getArrayLine($cls_db->ExecuteQuery($query));

$UserIniName = $result!=null?$result["UserName"]:"";
...
<script>
    ...
    switchMenuImg("F5");
    F5_button = function(){
        location.href="resoconto_inipec.php?c=<?php echo $c; ?>&a=<?php echo $a; ?>";
    }
    ...
    function creaTabella(){
        $.ajax({
            ...
            success: function( data ) {
                var toprint = [
                    {originalName: "UserName", replacedName: "Codice utente infocamere"},
                    ...
                    {originalName: "Pec_Ricevute", replacedName: "Pec ricevute"}
                ];
                var widthCell = ["20%","24%","20%","12%","12%","12%"];
                var fontsize = "10px";
    ...
    function ajaxCall() {
        ...
        $.ajax({
            ...
            success: function (resp) {
                ...
                if(resp.error == 0)
                    showFileOnModal(resp.path,"Resoconto INIPEC",resp.path.split('.').pop());
            },
            error:function(resp)
            {
                spinner.closeSpinner();
    ...
    <form id="resoconto_form" action="print_resoconto.php" method="post" >
        ...
        <div class="row justify-content-md-center " style="margin: 2%;">
            <div class="col col-md-auto text_center">
                <span class="titolo font16 under_decor">Stampa resoconto INIPEC</span>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col col-lg-offset-1  col-lg-5">
                <label class="col-lg-6 control-label resize" style="text-align: left;">Codice utente infocamere</label>
                <div class="form-group">
                    <div class="col-lg-6">
                        <input class="form-control resize validateCustom vld_Custom_r" type="text" id="UserName" name="UserName" value="<?=$UserIniName;?>">
                    </div>
                </div>
            </div>
