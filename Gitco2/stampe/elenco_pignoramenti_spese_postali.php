...
$styleRetta = array('dash' => '0');
	...
	$array_width = array( 20 , 20 , 50 , 100 );
	
	$array_width_sotto = array( 90 , 100 );
				...
				for( $j=0; $j<$num_utenti; $j++ )//FOR UTENTI
				{
					if( $array_partite[$k]['Utente_ID'] == $array_utenti[$j]['ID'] )//IF PARTITA/UTENTE
					{
						...
						if( strlen($nome_utente) > 25 )
							$nome_utente = substr($nome_utente,0,24)."...";
						...
						$array_value_1[] = $partita->Comune_ID."/".$partita->Anno_Riferimento;
