...
?>
    ...
    <script>
        ...
        function submitFlow(id){
            ...
            window.opener.location.replace("info_flussi.php?a=<?php echo $a; ?>&c=<?php echo $c; ?>&tipo=<?php echo $filter['docType']; ?>&stampatore=<?php echo $filter['PrinterId']; ?>&id_flows="+id_json);
            //}
            //$('#flusso_form').submit();
            window.close();
            //window.close();
