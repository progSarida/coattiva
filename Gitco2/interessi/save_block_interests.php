...
if(!$cls_db->DbSave($cls_Utils->GetObjectQuery($save,"lockup_periods"))){
    $cls_db->Rollback();
    $msg = "Salvataggio fallito! Errore nell'inserimento dati";
    $error = 1;
}
...
if($error == 0)
    $storico->insRow('I', "Inserito periodo blocco interessi".$nome_ente);
