...
$query = "SELECT * FROM lockup_periods WHERE Id = ".$id;
$data = $cls_db->getArrayLineNull($cls_db->ExecuteQuery($query),"lockup_periods");
...
for($i=0; $i < $count; $i++){
    $selOpt = "";
    if($data["CC"] == $city[$i]["CC"]) $selOpt = "selected";
    $dropCity .= "<option value='".$city[$i]["CC"]."' ".$selOpt.">".$city[$i]["Denominazione"]."</option>";
}
...
for($i=0; $i < $count; $i++){
    $selOpt = "";
    if($data["Lockup_Type_Id"] == $interestType[$i]["Id"]) $selOpt = "selected";
    $dropInterestType .= "<option value='".$interestType[$i]["Id"]."' ".$selOpt.">".$interestType[$i]["Name"]."</option>";
}
...
<form action="update_block_interests.php" method="post" name="form_block_interests" id="form_block_interests">
    ...
    <div class="row" style="margin-top: 1%;">
        <div class="col col-lg-5 col-lg-offset-1">
            <div class="form-group">
                ...
                <div class="col-lg-7">
                    <input class="text_left form-control resize picker validateCustom vld_Custom_r vld_CheckInterestDate"  id=start_date name=start_date value="<?= $cls_date->Get_DateNewFormat($data["Start_Date"],'DB'); ?>">
                </div>
            </div>
        </div>
        <div class="col col-lg-5">
            <div class="form-group">
                ...
                <div class="col-lg-7">
                    <input class="text_left form-control resize picker validateCustom vld_Custom_r vld_CheckInterestDate"  id=end_date name=end_date value="<?= $cls_date->Get_DateNewFormat($data["End_Date"],'DB'); ?>">
                </div>
            </div>
        </div>
    </div>
    <div class="row" style="margin-top: 1%;">
        <div class="col col-lg-10 col-lg-offset-1">
            <div class="form-group">
                ...
                <div class="col-lg-10">
                    <input class="text_left form-control resize validateCustom vld_Custom_r"  id=name name=name value="<?= $data["Name"]; ?>">
                </div>
            </div>
        </div>
    </div>
    <div class="row" style="margin-top: 1%;">
        <div class="col col-lg-10 col-lg-offset-1">
            <div class="form-group">
                ...
                <div class="col-lg-10">
                    <textarea style="max-width: 100%;" class="form-control resize" name="description" id="description" ><?= $data["Description"]; ?></textarea>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="row" style="margin-top: 3%;">
        <div class="col-lg-10 col-lg-offset-1">
            <div class="form-group">
                <button style="width: 100%;" type="button" id="btnSub" class="btn btn-primary" onclick="updateData();">Aggiorna</button>
            </div>
        </div>
    </div>
</form>
