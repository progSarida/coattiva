...
if($p!="")
{
    if($Visura_DB=="no"){
        ...
        if($dataResult < date("Y-m-d")){
            ...
            $count = 0;
            //var_dump($resultSoap);
            //var_dump($resultSoap->DatiRisposta->ElencoVeicoli->Veicolo[0]);
                ...
                <div class="row historyDiv showHide_<?= $i; ?>" style="background-color: <?= $bg1; ?>; border: 1px solid white; display: none;">
                    <div class="col-lg-12">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-3">Data immatricolazione: <?= $cls_date->Get_DateNewFormat($result[$i]["DataPrimaImmatricolazione"],"DB"); ?></div>
                        </div>
