                    ...
                    <ul class="nav navbar-nav">
                        ...
                        <li class="dropdown nav-item">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li class="dropdown-submenu">
                                    <a href="#" class="submenu dropdown-item dropdown-toggle" data-toggle="dropdown">Sgravi &nbsp;<i class="fa fa-caret-right" aria-hidden="true"></i></a>
                                    <ul class="dropdown-menu">
                                        <li class="dropdown-submenu">
                                            <li><a onclick="menuClick('200');" href="#">Elaborazione massiva</a></li>
<!--                                            <li><a onclick="menuClick('256');" href="#">Report sgravio automatico</a></li>-->
<!--                                            <li><a onclick="menuClick('255');" href="#">Visualizza file sgravi/annullamenti</a></li>-->
                                        </li>
                                    </ul>
                                </li>
                                <li class="dropdown-submenu">
                                    <a href="#" class="submenu dropdown-item dropdown-toggle" data-toggle="dropdown">Discarico &nbsp;<i class="fa fa-caret-right" aria-hidden="true"></i></a>
                                    <ul class="dropdown-menu">
                                        <li class="dropdown-submenu">
                                    ...
                                    <ul class="dropdown-menu">
                                        ...
                                        <li class="dropdown-submenu">
                                            ...
                                            <ul class="dropdown-menu">
                                                ...
                                                <li><a onclick="menuClick('204');" href="#">Sgravi / annullamenti</a></li>
    ...
    <ul class="text_left">
        ...
        <li class="li_hc"><a href="#" target="_self">Elaborazioni</a>
            <ul class="ul_ch">
                ...
                <li><a href="#" target="_self">Sgravi / Annullamenti</a>
                    <ul class="ul_ch">
                        <li class="li_nc"><a onclick="menuClick('200');" href="#">Crea sgravio automatico</a></li>
                        <li class="li_nc"><a onclick="menuClick('256');" href="#">Report sgravio automatico</a></li>
                        <li class="li_nc"><a onclick="menuClick('204');" href="#">Stampe sgravi/annullamenti</a></li>
                        <li class="li_nc"><a onclick="menuClick('255');" href="#">Visualizza file sgravi/annull</a></li>
                    </ul>
                </li>
                <?php if ($_SESSION['CC_User'] == '****' || $_SESSION['CC_User'] == '***+') {
                    ?>
                    <li><a href="#" target="_self">Discarico</a>
                        <ul class="ul_ch">
                            <li class="li_nc"><a onclick="menuClick('3011');" href="#">Elaborazione</a></li>
                            <li class="li_nc"><a onclick="menuClick('3012');" href="#">Estrazione</a></li>
                        </ul>
                    </li>
                <?php }
                ?>
