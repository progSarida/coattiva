...
<script>
    alert("LA SESSIONE È SCADUTA. È NECESSARIO RIAUTENTICARSI")
    window.location.href="<?=SUPER_WEB_ROOT?>";
</script>
...
<head>
    ...
    <link rel=StyleSheet href="<?= CSS ?>/NavbarCss.css" type="text/css" media=screen>
    <link rel=StyleSheet href="<?= CSS ?>/myAlert.css" type="text/css" media=screen>
    ...
    <script src="<?= JS ?>/mySpinner.js" type="text/javascript" ></script>
    ...
    <script>
        ...
        function showFileOnModal(path,title,type,redirect){
            ...
            if(path == "" || path == null || path == undefined){
                swal({
                    ...
                    title: "ATTENZIONE!",
                    icon: 'error',
                    text: 'Nessun file da visualizzare/scaricare!',
            ...
            /*if(path == ""){
                ShowAlert(2,"Nessun file da visualizzare!");
                return false;
            }*/
            $("#frameHelp").attr("src",path);
            if(type == "pdf" || type == undefined || type == "png" || type == "jpg" || type == "jpeg" || type == "jpe" || type == "jfif" || type == "exif" || type == "bmp" || type == "dib" || type == "rle" || type == "webp"){
                $("#helpModalLabel").empty().append("<b>"+title+"</b>");
                ...
                if(redirect == undefined){
                    ...
                    swal({
                        title: "SUCCESS!",
                        text: "File generati correttamente, controllare in 'Comunicazioni Ente->Comunicazioni'!",
                        icon: "success",
                        timer: 25000,
                        button: 'CONFERMA'
                    }).then(function () {
        ...
        function startSpinner(){
            $("#caricamento_spinners").show();
        }

        function closeSpinner(){
            $("#caricamento_spinners").hide();
        }

        function updateSpinner(val){
            $("#text_spiners").text("<strong>"+val+" %</strong>");
        }
...
<div class="container-fluid" style="width: 85%; min-height: 100%; min-width: 1200px;">
  <div id="cityAdminHeader" class="row justify-content-lg-center table_azzurra_bootstrap" >
  ...
  <div class="row justify-content-lg-center table_azzurra_bootstrap " style="min-height: 90vh !important;">
      ...
      <!-- Modal Help-->
      <div class="modal fade" id="helpModal" tabindex="-1" style="z-index: 10000 !important;" aria-labelledby="helpModalLabel" aria-hidden="true">
          <div class="modal-dialog" style="width: 65% !important;height: 85vh !important;z-index: 10000 !important;">
              <div class="modal-content" style="height: 85vh !important;z-index: 10000 !important;">
                  <div class="modal-header">
                      <h5 class="modal-title" id="helpModalLabel" style="color: blue;"></h5>
                  ...
                  <div class="modal-body">
                      <iframe style="width: 100%;height: 75vh;" id="frameHelp" src=""></iframe>
                  </div>
              </div>
          </div>
      </div>
      ...
      <!-- The Modal -->
      <div id="myModalAlert" class="modalAlertCustom">

          <!-- Modal content -->
          <div class="modal-content-alert">
              <div class="containerCloseButton"><div class="closeAlert">&times;</div></div>
              <p class="containerTextAlert"></p>
          </div>

      </div>

      <div id="spinner_page"></div>