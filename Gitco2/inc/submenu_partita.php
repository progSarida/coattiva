...
<script>
    ...
    function getSubmenuPagename(number){
        switch(number){
            ...
            case 13: pagename = "crisis_tools_list"; break;
    ...
    function setLinkMenu(){
        if((pageNo>0 && pageNo<6) || (pageNo > 8 && pageNo < 11) || pageNo == 13)
            $('#iterIngiuntivo').show();
    ...
    <tr id="iterIngiuntivo" style="display:none;">
        ...
        <td class="width12">
            <a href="#" onclick="openSubLink(getSubmenuPagename(9));" style="text-decoration: none;">
                <span id="spanPage9" class="titolo font15">Discarichi</span>
            </a>
        </td>
        <td class="width13">
        ...
        <td class="width12">
            <a href="#" onclick="openSubLink(getSubmenuPagename(13));" style="text-decoration: none;">
                <span id="spanPage13" class="titolo font15">Strumenti di crisi</span>
            </a>
        </td>
        <td class="width13">
...
<!--        </td>-->
        ...
        <td class="width17">
            <a href="#" onclick="openSubLink(getSubmenuPagename(11));" style="text-decoration: none;">
                <span id="spanPage11" class="titolo font15">Discarichi</span>
            </a>
        </td>
        <td class="width17">
...
<?php
if(!empty($partita_Menu->Flag_Coobbligati) && $partita_Menu->Flag_Coobbligati==1){
    ?>
    <div class="row" style="margin-top:10px;">
        <div class="col-md-2"></div>
        <div class="col-md-8 text-center" style="background:whitesmoke; color:red; border: solid 1px red;">
            <b>PARTITA BLOCCATA PER PRESENZA COOBBLIGATI</b>
        </div>
        <div class="col-md-2"></div>
    </div>
    <?php
