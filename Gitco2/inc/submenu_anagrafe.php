...
<table align=center class=table_interna border=0 style="border:3px solid #6D95D5;">
	<tr>
		<td width=8% class="text_center">
			<a onMouseover="title='Cerca utente'" href="#" onclick="/*RicercheDaId('utente',0);*/openOfcanvas('userSearchModal',0);" style="text-decoration: none;">
...
<script type="text/javascript">
    ...
    //Lanciato da inserimento
    function control_ind(){
        //Se utente esiste setta il tipo di comune cap/non gen
        if(utente_ID!=0)
        {
            if($('#ID_via').val()==1)
            {
        ...
        //Se utente non esiste proverà a chiamara modale, ma verrà fermato da controllo di openOfcanvas
        openOfcanvas('addrSearchModal',0);
    }
