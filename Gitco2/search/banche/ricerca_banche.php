...
$ID_sede = array();
$nascondi_filiale = false;
switch ($richiesta)
{
	case("assegnaBancaPigno"):
		$nascondi_filiale = true;
	...
	case ("singola"):
		...
		if($nascondi_filiale)
			$linkricerca = "ricerca_banche.php?richiesta=assegnaBancaPigno&posted=true&c=".$c;
		else
		...
		if ($nascondi_filiale)
			$cella[0] = "Sede <input id=tipo_banca type=radio name=tipo_banca value='sede' ".$checked_sede.">";
		else
