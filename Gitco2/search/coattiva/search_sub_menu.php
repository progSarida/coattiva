...
switch ($richiesta)
{
	...
	case ("ricCrono"):
		...
		$linkricerca = "search_sub_menu.php?richiesta=ricCrono&posted=true&c=".$c."&a=".$a;
		...
		if( $posted == true )
		{
            ...
            $query.= "WHERE AT.Partita_ID = PA.ID AND PA.CC = '".$c."' AND PA.Is_Discharged=0 ";
			if($anno_crono!=null)
	...
	case ("ricPigno"):
		...
		$linkricerca = "search_sub_menu.php?richiesta=ricPigno&posted=true&c=".$c."&a=".$a;
		...
		if( $posted == true )
		{
			...
			$query.= "WHERE PG.Partita_ID = PA.ID AND PA.Is_Discharged=0 ";
			if($anno_crono!=null)
	...
	case ("ricInfoCart"):
		...
		$linkricerca = "search_sub_menu.php?richiesta=ricInfoCart&posted=true&c=".$c."&a=".$a;
		...
		if( $posted == true )
		{
			...
			$query.= "WHERE TR.Partita_ID = PA.ID AND TR.Info_Cartella LIKE '%".addslashes($ric_info)."%' AND PA.CC = '".$c."' AND PA.Is_Discharged=0 ";
	...
	case ("ricUtente"):
		 ...
		 $titolopagina = "Ricerca Utente";
		  $linkricerca = "search_sub_menu.php?richiesta=ricUtente&posted=true&c=".$c."&a=".$a;
	...
	case ("ricCF"):
			...
			$linkricerca = "search_sub_menu.php?richiesta=ricCF&posted=true&c=".$c."&a=".$a;
		...
		case ("ricDescRuolo"):
			...
			$titolopagina = "Ricerca Ruolo";
			$linkricerca = "search_sub_menu.php?richiesta=ricDescRuolo&posted=true&c=".$c;
		...
		case ("ricDataRuolo"):
				...
				$titolopagina = "Ricerca Ruolo";
				$linkricerca = "search_sub_menu.php?richiesta=ricDataRuolo&posted=true&c=".$c;
			...
			case ("ricDescCod"):
				...
				$titolopagina = "Ricerca Codice Tributo";
				$linkricerca = "search_sub_menu.php?richiesta=ricDescCod&posted=true&c=".$c."&settore=".$settore."&sottosettore=".$sottosettore;
			...
			case ("ricCodice"):
				...
				$titolopagina = "Ricerca Codice Tributo";
				$linkricerca = "search_sub_menu.php?richiesta=ricCodice&posted=true&c=".$c."&settore=".$settore."&sottosettore=".$sottosettore;
			...
			case ("listaCodice"):
					...
					$linkricerca = "search_sub_menu.php?richiesta=ricCodice&posted=true&c=".$c;
...
//       window.opener.callParent();
        	...
        	function GeneraLinkPagina(richiesta)
			{
				...
				case ("generale"):
					...
					link = "search_sub_menu.php?richiesta="+radio+"&c=<?php echo $c; ?>&a=<?php echo $a; ?>";
...
{
    try{
        window.opener.callParentSubMenu(value);
    }
    catch(e){
        alert(e.description);
    }
