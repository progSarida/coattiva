...
if($id_richiesta!=0)
{
	...
	$file_richiesta = substr( $path."/".$richiesta_doc["File"] , strpos( $path."/".$richiesta_doc["File"] , "/archivio/" )); //mostra_file_path($path."/".$richiesta_doc->File);
}
else
	$file_richiesta = "";
...
if($id_esito!=0)
{
	...
	$file_esito = substr( $path."/".$esito_doc["File"], strpos( $path."/".$esito_doc["File"] , "/archivio/" )); //mostra_file_path($path."/".$esito_doc->File);
}
else
	$file_esito = "";
...
if($id_bollettini!=0)
{
	...
	$file_bollettini = substr( $path."/".$bollettini_doc["File"], strpos( $path."/".$bollettini_doc["File"] , "/archivio/" )); //mostra_file_path($path."/".$bollettini_doc->File);
}
else
	$file_bollettini = "";
