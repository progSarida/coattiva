...
//            case 14:    $a_toSave['IMPORTO'] = $row['ONERI_RISCOSSIONE'];           break;
    ...
    if($saltaRecord==1)
        ...
        $parzialeAtto = (double)$row['ONERI_RISCOSSIONE']+(double)$row['INTERESSI_ATTO']+(double)$row['SPESE_NOTIFICA_ATTO'];
        if($row['TIPO_ATTO']!=""){
...
//                else
                    ...
                    $a_bind = array($a_toSave['CC_IMPORTAZIONE'],$a_toSave['PARTITA_ID'],$a_toSave['INFORMAZIONI_CARTELLA'],$a_toSave['DATA_NOTIFICA_ATTO'],
                        ...
                        "diretta", "posta", (double)$row['INTERESSI_ATTO'], (double)$row['SPESE_NOTIFICA_ATTO'], (double)$row['DOVUTO_TOTALE']
                    );
