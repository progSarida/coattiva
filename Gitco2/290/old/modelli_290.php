...
$c = get_var('c');
$p = get_var('p');
$control_submit = get_var('submit_file');
...
$path_file = mostra_file_path(MODELLI);

$xls1 = $path_file."/MODELLO_IMPORTAZIONE.xls";
$xls2 = $path_file."/Modello_290_Secondario.xls";
$doc1 = $path_file."/HELP_290_Principale.doc";
$doc2 = $path_file."/HELP_290_Secondario.doc";
...
var xls1 = "<?php echo $xls1; ?>";
var xls2 = "<?php echo $xls2; ?>";

function apri_file(ext, value)
{
	if( ext == "doc" )
		if(value == "1")	link = doc1;
		else				link = doc2;

	if( ext == "xls" )
		if(value == "1")	link = xls1;
		else				link = xls2;
...
<table class="table_interna text_center">
	<tr>
		...
		<td align="center">
			<font class="titolo font20 under_decor">Modelli 290 xls impostazioni personalizzate</font>
		</td>
...
<br>
<table class="table_interna text_center" cellpadding=0 cellspacing=0>
	<tr>
		<td colspan=2 class="text_left width10"><font class="color_titolo">File</font></td>
		<td class="text_left width90"><font class="color_titolo">Descrizione</font></td>
	</tr>
	<tr>
		<td colspan=3><hr></td>
	</tr>
	<tr>
		<td colspan=2 class="text_left width10">
			<a href="#" onMouseover="title='Modello principale'" onclick="apri_file('xls',1);" style="text-decoration: none;">
	          	<img src="/gitco2/immagini/icon-excel.png" width=30px height=30px border="0">
	        </a>
		</td>
		<td class="text_left width90">
			<b>Modello Principale:</b> File Excel per modello 290 principale in formato .xls
		</td>		
	</tr>
</table>
