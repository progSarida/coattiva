...
for($i = 0;$i<$count;$i++){
    ...
    $tableElem[$i]["select"] = "<i onclick='initialId(\"addr_gen\",".str_replace("'","&apos;",json_encode($result[$i]))."); $(\".offcanvas\").modal(\"hide\");' style='cursor: pointer;color: #0c63e4;' class='fas fa-arrow-right'></i>";
}
