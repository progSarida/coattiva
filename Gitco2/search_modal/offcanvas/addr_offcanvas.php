                    ...
                    <div class="col-lg-4" >
                                ...
                                <div class="row">
                                    <div>
                                        <div class="form-group">
                                            ...
                                            <input class="col-lg-1" id=check_cap type=radio name=tipo_a value=cap onclick="/*switchRic_c()*/">
                                        </div>
                                        <div class="form-group">
                                            <label class="col-lg-5" for="check_gen" id="check_gen_label">Indirizzo generico</label>
                                            <input class="col-lg-1" id=check_gen type=radio name=tipo_a value=gen onclick="/*switchRic_nc()*/">
                                        </div>
                                    </div>
                                </div style="marg">
                            </div>
                        ...
                        <div id="ins_addr_c">
                                ...
                                <div class="row" style="margin-top: 4%;">
                                    <div class="col-lg-12"><button type="button" class="btn btn-primary" style="width: 100%;" onclick="startAjaxAddr($('[name=tipo_a]:checked').val())">Cerca</button></div>
                                </div>
                        </div>
...
<script>
    ...
    $(document).ready(function (){
        $('[name="tipo_a"]').on("change", function(){
            //alert($(this).val());
            if($(this).val() == "cap"){
                <!-- nasconde ricerca generica -->
                //document.getElementById('addrSearchModalLabel_nc').hidden = true;
    ...
    $(".address").keyup(function(event) {
        if (event.keyCode === 13) {
            startAjaxAddr($('[name=tipo_a]:checked').val());
        }
    });
</script>