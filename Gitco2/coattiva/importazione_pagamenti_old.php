...
$PathCompletoImportPagamenti = $_SERVER['DOCUMENT_ROOT'] . "/gitco2.com/archivio/Importazioni_Pagamenti/";
$PathCompletoPagamentiEsteri = $_SERVER['DOCUMENT_ROOT'] . "/gitco2.com/archivio/Targhe_Estere/Pagamenti/";
$PathImportazioniPagamenti = $_SERVER['DOCUMENT_ROOT'] . "/gitco2.com/archivio/Importazioni_Pagamenti/";
$PathCompletoPagamentiDaBonificare = $_SERVER['DOCUMENT_ROOT'] . "/gitco2.com/archivio/Importazioni_Pagamenti/DaBonificare/";
...
$archivioPath = $_SERVER['DOCUMENT_ROOT']."/gitco2.com/archivio";
	...
	for ($k = 0; $k < $countContenuto; $k++)
	{
		...
		switch ($quintoTipoServizio)  //  tipo servizio
		{
			case "00":
				...
				$breveTipo = "ACC";
				$cartellaPagAvvisi = "/gitco2.com/archivio/Atti/" . $quintoCcComune . "/Pagamenti/";
