...
// 				$layout .= "<script>$('#num_rata').prop('disabled',false);</script>";
			...
			$importo = $cls_mathF->conv_num( number_format($pag["Importo"],2));
...
?>
	...
	importo[<?php echo $y; ?>] = "<?php echo $cls_mathF->conv_num(number_format($pagamento[$y]["Importo"],2)); ?>";
...
<thead>
	<tr class="text_left riga_dispari" style="height:30px;" >
		<th style="position: sticky; top: 0; background-color: #6B8BFF;" class="width4"><br></td>
		<th style="position: sticky; top: 0; background-color: #6B8BFF;" class="width1"><br></td>
		<th style="position: sticky; top: 0; background-color: #6B8BFF;" class="text_center width6"><b>Rata</b></td>
		<th style="position: sticky; top: 0; background-color: #6B8BFF;" class="width1"><br></td>
		<th style="position: sticky; top: 0; background-color: #6B8BFF;" class="text_center width14"><b>Cronologico</b></td>
		<th style="position: sticky; top: 0; background-color: #6B8BFF;" class="width1"><br></td>
		<th style="position: sticky; top: 0; background-color: #6B8BFF;" class="text_left width21"><b>Atto</b></td>
		<th style="position: sticky; top: 0; background-color: #6B8BFF;" class="width1"><br></td>
		<th style="position: sticky; top: 0; background-color: #6B8BFF;" class="text_center width15"><b>Tot. dovuto (&euro;)</b></td>
		<th style="position: sticky; top: 0; background-color: #6B8BFF;" class="width1"><br></td>
		<th style="position: sticky; top: 0; background-color: #6B8BFF;" class="text_center width18"><b>Data Pagamento</b></td>
		<th style="position: sticky; top: 0; background-color: #6B8BFF;" class="width1"><br></td>
		<th style="position: sticky; top: 0; background-color: #6B8BFF;" class="text_center width15"><b>Pagato (&euro;)</b></td>
		<th style="position: sticky; top: 0; background-color: #6B8BFF;" class="width1"><br></td>
	</tr>
<thead>
<tbody>
...
for($i=count($pagamento)-1; $i>=0; $i--)
{
	...
	if($pagamento[$i]["Dovuto"]!=null)
		$dovuto = $cls_mathF->conv_num(number_format($pagamento[$i]["Dovuto"],2));
	else
		$dovuto = "";
?>


<tr <?php echo $stile_riga; ?> id="riga_<?= $i; ?>" style="<?= $i == 0?"color: red;":""; ?>">
	<td class="width4">
	...
	<td><br></td>
	<td class="text_center"><?php echo $cls_mathF->conv_num(number_format($pagamento[$i]["Importo"],2)); ?></td>
	<td><br></td>
</tr>
...
<div class="row" style="margin-top: 2%;">
	...
	<div class="col-lg-2">
		...
		<div class="row" style="margin-top: 62%;">
			<div class="col-lg-12">
				<div id=mostra_immagine class="image-magnify2" title="Clicca per allargare immagine" onclick="window.open('<?php echo $src_immagine; ?>')"><!-- QUESTO DA TENERE FORSE SI PIUò FARE FLOAT RIGHT E LE ROW FLOAT LEFT -->
...
if($atto[$i]["ID_Cronologico"]!=0){?>
	...
	<div class="row">
		<div class="col col-lg-3 col-lg-offset-1">
			<div class="form-group">
				<label class="col-lg-6 control-label resize" style="text-align: left;"><font class="color_titolo font_bold">Pagamento di </font></label>
				<div class="col-lg-6">
					<input class="form-control resize readonly" style="border: 2px solid black; background-color: rgb(153, 204, 255);" value="<?php echo $cls_mathF->conv_num(number_format($somma_pagamenti[$i],2)); ?>" size=5 readonly>
				</div>
			</div>
		</div>
		<div class="col col-lg-1">
			<div class="form-group">
				...
				<div class="col-lg-12">
					<p style=" text-align: center;">&euro;&nbsp;<font class="color_titolo font_bold"> su</font></p>
				</div>
			</div>
		</div>
		<div class="col col-lg-2">
			<div class="form-group">
				<!--<label class="col-lg-4 control-label resize" style="text-align: left;">Note</label>-->
				<div class="col-lg-12">
					<input class="form-control resize readonly" style="width: 70%; border: 2px solid black; background-color: rgb(153, 204, 255);" value="<?php echo $cls_mathF->conv_num(number_format($atto[$i]["Totale_Dovuto"],2)); ?>" size=5 readonly>
				</div>
			</div>
		</div>
		<div class="col col-lg-4">
