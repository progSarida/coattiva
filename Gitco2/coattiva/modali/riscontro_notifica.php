...
<title>Riscontro notifica</title>
...
<table class="text_center pwidth750" border="0" cellspacing="5" cellpadding="0">
	<tr>
		<td><font class="titolo font18">Gestione riscontro</font></td>
	</tr>
</table>

<br>

<form id=form_riscontro name=form_riscontro enctype="multipart/form-data" action="riscontro_notifica_salva.php" method=post>
...
<table class="text_center pwidth750" border="0">
	<tr>
		...
		<td class="text_center width48"></td>
	</tr>
	<tr>
		<td class="text_right width28">
