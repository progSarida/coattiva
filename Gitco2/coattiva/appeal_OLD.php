        ...
        <div class="row tr_datiGenerali">
            <div class="col col-lg-5 col-lg-offset-1">
                <div class="form-group">
                    ...
                    <div class="col-lg-8">
                        <input name="Authority_Name" id="authorityName" style="background-color: rgb(153, 204, 255); border: 2px solid black;" class="form-control resize readonly text_left" onclick="Appeal.searchAuthority();" readonly value="<?=$a_appeal['Authority_Description'];?>">
