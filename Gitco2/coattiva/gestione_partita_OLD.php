...
//echo $num_atti." ".$control_modifiche;
	...
	$layout.= "<script>$('#sanzione').hide();$('#entrata').hide();$('#matricola').hide();</script>";
...
//		echo $ingExp[4];
		...
		//echo "<h1>info --> ".$tipo_info_gen."</h1>";

		switch($tipo_info_gen)
		{
			case "S":

				$info_S = " selected ";
				$layout .= "<script>$('#sanzione').show();</script>";

				$variabile =  "<div class='row justify-content-md-center '>";
				$variabile .= "  <div class='col col-md-auto text_center'>";
				$variabile .= "    <p class='titolo font16 under_decor' id=tipo_trib_new></p>";
				$variabile .= "  </div>";
				$variabile .= "</div>";

				$variabile .= "<div id=new_codice>";
				$variabile .= "	<div class='col col-lg-3 col-lg-offset-1'>";
				$variabile .= "	  <div class='form-group'>";
				$variabile .= "	    <label class='col-lg-4 control-label resize' style='text-align: left;'>Codice Tributo*</label>";
				$variabile .= "	    <div class='col-lg-8'>";
				$variabile .= "	      <input id=cod_tributo_new class='form-control resize validateCustom vld_Custom_r' style='background-color: rgb(153, 204, 255); border: 2px solid black; width: 50%;' readonly name=cod_tributo_new type=text value='' size=4>";
				$variabile .= "	    </div>";
				$variabile .= "	  </div>";
				$variabile .= "	</div>";
				$variabile .= "	<div class='col col-lg-3'>";
				$variabile .= "	  <div class='form-group'>";
				$variabile .= "	    <label class='col-lg-4 control-label resize' style='text-align: left;'>Atto</label>";
				$variabile .= "	    <div class='col-lg-8'>";
				$variabile .= "			  <select id=select_atto_new name=select_atto_new  onchange='cambia_atto();' class='pwidth150 form-control resize'>";
				$variabile .= "			  	<option value=VE >Verbale</option>";
				$variabile .= "			  	<option value=OR >Ordinanza</option>";
				$variabile .= "			  	<option value=IN >Ingiunzione</option>";
				$variabile .= "			  	<option value=DM >Decreto Ministeriale</option>";
				$variabile .= "			  </select>";
				$variabile .= "	    </div>";
				$variabile .= "	  </div>";
				$variabile .= "  </div>";
				$variabile .= "	<div class='col col-lg-3'>";
				$variabile .= "	  <div class='form-group'>";
				$variabile .= "	    <label class='col-lg-4 control-label resize' style='text-align: left;'>Importo *</label>";
				$variabile .= "	    <div class='col-lg-8'>";
				$variabile .= "	      <input id=importo_new class='form-control resize corrige_numero validateCustom vld_Custom_d vld_Custom_r' style='width: 50%;' name=importo_new type=text value='' size=6>";
				$variabile .= "	    </div>";
				$variabile .= "	  </div>";
				$variabile .= "	</div>";
				$variabile .= "</div>";
			...
			case "E":
				$info_E = " selected ";
				$layout .= "<script>$('#entrata').show();</script>";
			...
			case "M":
				...
				$info_M = " selected ";
				$layout .= "<script>$('#matricola').show();</script>";
		...
		for($y=0;$y<count($tributo);$y++)
		{
			...
			//echo "<h1>count: ".count($partita["Atto"])."</h1>";
//			if ($tributo[$y]->Codice_Tributo == 5354)
//			{
//				$parametri_annuale = new gestione_parametri_annuali($c, $a, "CDS");
//				//if ($_SESSION['CC_User'] == "***+") alert ($parametri_annuale->ID);
//
//				if ($parametri_annuale->ID != "")
//				{
//					$spesenot = $tributo[$y]->Imposta - $parametri_annuale->Spese_Ricerca;
//					$testo = "Spese Notifica  " . number_format($spesenot, 2, ",", ".");
//					$testo .= "\nSpese Ricerca  " . number_format($parametri_annuale->Spese_Ricerca, 2, ",", ".");
//					$divisione_spesa[$y] = "<label title='" . $testo . "'>(*)</label>";
//				}
//				else
//				{
//					$testo = "ATTENZIONE:\nmanca il parametro annuale delle spese di ricerca";
//					$testo .= "\nper il comune di " . $nome_comune . " nel " . $a;
//					$divisione_spesa[$y] = "<font color=red><label title='" . $testo . "'>(*)</label></font>";
//				}
//			}
//			else if($tributo[$y]->Codice_Tributo == 5242 && $tributo[$y]->Pagamenti_Associati != 0 && $tributo[$y]->Tipo_Sanzione = "VE")
//			{
//				$tot_verbale = 0;
//				for($z=0;$z<count($tributo);$z++)
//				{
//					$tot_verbale+= $tributo[$z]->Imposta;
//				}
//
//				$testo = "    ".number_format($tot_verbale, 2, ",", ".") . " Euro ( Totale verbale )\n";
//				$testo.= "-  " . number_format($tributo[$y]->Pagamenti_Associati, 2, ",", ".") . " Euro ( Pagamenti verbale )\n";
//				$testo.= "= " . number_format($tot_verbale - $tributo[$y]->Pagamenti_Associati, 2, ",", ".") . " Euro ( Credito residuo )";
//				$divisione_spesa[$y] = "<font color=green><label title='" . $testo . "'>(*)</label></font>";
//			}
//			else $divisione_spesa[$y] = "";
		}
	}
	...
	$val = $cls_db->getArrayLine($cls_db->ExecuteQuery($query));
...
function cambia_tipo()
{
	...
	switch($('#select_info').val())
	{
		case "S":
			...
			variabile =  "<div style='border-top: 2px solid #B0BBE8; width: 90%; margin-left: 5%;'></div>";
			variabile += "<div id=new_codice style='margin-top: 2%;'>";
			variabile += "	<div class='col col-lg-3 col-lg-offset-1'>";
			variabile += "	  <div class='form-group'>";
			variabile += "	    <label class='col-lg-4 control-label resize' style='text-align: left;'>Codice Tributo *</label>";
			variabile += "	    <div class='col-lg-8'>";
...
function RicercheDaId (value, rif)
{
    ...
    switch(value)
    {
        ...
        case "lista":
            ...
            var stringa = "<?= WEB_ROOT; ?>/search/comuni/ricerca_alert_modale.php?richiesta=listaCodice&posted=true&c=<?php echo $c; ?>&a=<?php echo $a; ?>";
...
function cambio_info()
{
	...
	if(info_cart.length>=250)
	{
		alert("La lunghezza del testo non puo' essere superiore ai 250 caratteri!");
		$('#info_cartella').val(info_cart.substring(0, 250));
	}
}
...
<div class="row">
	<div class="col col-lg-3 col-lg-offset-1">
		<div class="form-group">
			<label class="col-lg-4 control-label resize" style="text-align: left;">Data decor. interessi *</label>
			<div class="col-lg-8">
				<input id=data_interessi onchange="cambia_data_interessi();" class="form-control resize vld_dateReq" name=data_interessi type=text value='<?php echo $data_interessi; ?>' size=9 >
			</div>
		</div>
	</div>
			...
			<div class="col-lg-8">
				<select id=select_info name=select_info onchange="cambia_tipo();" class="form-control resize vld_req" >
					...
					<optgroup label="Seleziona un'opzione">
						<option id=s value=S <?php echo $info_S; ?>>Sanzione Amministrativa</option>
						<option id=e value=E <?php echo $info_E; ?>>Entrata Patrimoniale / Tributaria</option>
						<option id=m value=M <?php echo $info_M; ?>>Matricola</option>
					</optgroup>
				</select>
			</div>
		</div>
...
<div class="row" id=sanzione>
	...
	<div class="col col-lg-3">
		<div class="form-group">
			...
			<div class="col-lg-7">
				<input id=data_sanz class="form-control resize vld_dateReq" onchange="cambia_data_sanzione();"name=data_sanz type=text value='<?php echo $data_sanz; ?>' size=9>
			</div>
		</div>
	</div>
	<div class="col col-lg-3 col-lg-offset-1">
...
<div class="row" id=sanzione style="margin-bottom: 0;">
...
if(!$tributo && $utente_ID != 0)
	echo "<br><span class=color_red>IMPORTANTE!!!<br><br>INSERIRE PER PRIMO IL CODICE TRIBUTO DELL'IMPORTO PRINCIPALE<br><br></span>";
if($tributo)
    for($y=0;$y<count($tributo);$y++)
    {
        if($tipo_info_gen == "S")
...
<div class="col col-lg-3 col-lg-offset-1">
	<div class="form-group">
		<label class="col-lg-4 control-label resize" style="text-align: left;">Codice Tributo*</label>
		<div class="col-lg-8">
			<input id=cod_tributo_<?php echo $y; ?> class="form-control resize validateCustom vld_Custom_r" style="background-color: rgb(153, 204, 255); border: 2px solid black; width: 50%;" readonly name=cod_tributo[<?php echo $y; ?>] type=text value='<?php echo $codice_tributo[$y]; ?>' size=4 ondblclick="RicercheDaId('codice','<?php echo $y; ?>');" >
		</div>
	</div>
</div>
<div class="col col-lg-3">
	<div class="form-group">
		<label class="col-lg-4 control-label resize" style="text-align: left;">Atto</label>
		<div class="col-lg-8">
			<select id="select_atto_<?php echo ($y+1); ?>" name="select_atto[]"  onchange="cambia_atto();" class="pwidth150 form-control resize">
				<option value=VE <?php echo $atto_VE; ?>>Verbale</option>
				<option value=OR <?php echo $atto_OR; ?>>Ordinanza</option>
				<option value=IN <?php echo $atto_IN; ?>>Ingiunzione</option>
				<option value=DM <?php echo $atto_DM; ?>>Decreto Ministeriale</option>
			</select>
		</div>
	</div>
</div>
<div class="col col-lg-3">
	<div class="form-group">
		...
		<div class="col-lg-8">
			<input id="importo_<?php echo $y; ?>" class="form-control resize validateCustom vld_Custom_d vld_Custom_r corrige_numero" style="width: 50%;" name=importo[<?php echo $y; ?>] type=text value='<?php echo $imposta[$y]; ?>' size=6>
		</div>
	</div>
</div>
...
<script>$('#select_atto_<?php echo ($y+1); ?>').val("<?php echo $tipo_sanzione[$y]; ?>")</script>
<?php
	...
	<div class="row">
		...
		<div class="col col-lg-3">
			<div class="form-group">
				<label class="col-lg-4 control-label resize" style="text-align: left;">Importo *</label>
				<div class="col-lg-8">
					<input id="importo_<?php echo $y; ?>" class="form-control resize corrige_numero validateCustom vld_Custom_d vld_Custom_r" name=importo[<?php echo $y; ?>] type=text style="width: 50%;" value='<?php echo $imposta[$y]; ?>' size=6>
				</div>
			</div>
		</div>
		<div class="col col-lg-1 col-lg-offset-3">
			<div class="form-group">
				<div class="col-lg-12">
					<input type=button class="form-control resize btn-danger" name=elimina value="Elimina" onclick="elimina_tributo('<?php echo $id_tributo[$y]; ?>');">
				</div>
...
<div id=scrivi_nuovo class="row"></div>
