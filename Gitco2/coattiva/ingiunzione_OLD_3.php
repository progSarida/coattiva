...
if(count($atto)!=0)
{
    ...
    $disableFieldSollOrd = "";
    if($ing["DocumentTypeId"] == 3 && $ing["Modalita_Stampa"] == "ordinaria")
    ...
    if($ing["ID_Richiesta_Rateizzazione"] != null || $ing["ID_Esito_Rateizzazione"] != null || $ing["ID_Bollettini_Rateizzazione"] != null)
...
if($flagRateizzazione) $disabledRat = "disabled";
else $disabledRat = "";
...
?>
    ...
    <script>
        ...
        function dettagli_not(value)
        {
            ...
            if(documentTypeId[value] == 3 && modalita_stampa[value]=="ordinaria"){
        ...
        {?>
          ...
          <div class="row" style="margin-top: 2%;">
          	<div class="col col-lg-3 col-lg-offset-1">
                ...
                <div class=" col-lg-6">
                    <label>
                        <span class="color_titolo resize"><b>Rateizzazione</b></span> <input <?= $disabledRat; ?> type="checkbox" id=rate_id name=rateizza value=rateizza onclick="rateo();" <?php echo $rateizza; ?>>
                    </label>
                </div>
          			<div class="col-lg-6 resize">
                  Tot 1<input <?php echo $disable_radio_1; ?> <?= $disabledRat; ?> type=radio id=importo_rateizzazione_1 name=importo_rateizzazione value="1" <?php echo $checked_radio_1; ?> onclick="click_rate();" checked>
                  Tot 2<input <?php echo $disable_radio_2; ?> <?= $disabledRat; ?> <?php echo $checked_radio_2; ?> type=radio id=importo_rateizzazione_2 name=importo_rateizzazione value="2" onclick="click_rate();">
                </div>
          		</div>
          	</div>
            <div class="col col-lg-3">
          		<div class="form-group">
          			...
          			<div class="col-lg-6">
                  <input id=data_richiesta <?= $disabledRat; ?> class="form-control resize text_center picker" name=data_richiesta type=text value='<?php echo $cls_date->Get_DateNewFormat($data_richiesta,"DB"); ?>' size=9 <?php echo $disable; ?> onchange="change_data_rate();">
                </div>
          		</div>
          	</div>
            <div class="col col-lg-2">
          		<div class="form-group">
          			...
          			<div class="col-lg-5">
                  <input class="form-control resize" <?= $disabledRat; ?> type="text" id=num_rate name=num_rate value="<?php echo $rate_previste; ?>" size=2 <?php echo $disable; ?> onchange="change_num_rate();">
                </div>
          		</div>
          	</div>
            <div class="col col-lg-2">
          ...
          <div class="row" style="margin-top: 1%;">
              ...
              <div class="form-group">
                  <label class="control-label resize col-lg-12">
                    ...
                    <b>ARCHIVIAZIONE/Blocco coazione</b>
                  </label>
              </div>
            </div>
            <div class=" col-lg-5">
