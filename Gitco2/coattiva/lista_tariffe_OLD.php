...
?>
	...
	<tr class=" <?php echo $class_tipo; ?> info" >
    	...
    	<td class="text_center" ><?php echo $cls_math->conv_num(number_format($una_tantum[$i]['Importo'],2)); ?> &euro;</td>
...
for($i=0;$i<count($a_giorni);$i++)
{
	...
	<tr class=" <?php echo $class_tipo; ?> info" >
    	...
    	<td class="text_center" ><?php echo $cls_math->conv_num(number_format($a_giorni[$i]['Importo'],2)); ?> &euro;</td>
...
?>
	<tr class=" <?php echo $class_tipo; ?> info" >
    	...
    	<td class="text_center" ><?php echo $cls_math->conv_num(number_format($a_km[$i]['Importo'],2)); ?> &euro;</td>
    	<td class="text_left" ><?php echo $tariffa_fissa; ?></td>
	</tr>
